...
class Tools implements AdminTabInterface
{
    ...
    public function getViewVariables()
    {
        ...
        return compact('groups', 'sections', 'import_data_types');
    }
    ...
    protected function getSections()
    {
        return array(
            ...
            'import_rule_csv' => array(
                'title'       => __('Import Rules', 'advanced-dynamic-pricing-for-woocommerce'),
                'templates'   => array(
                    'import_rule_csv',
                ),
            ),
            ...
            "export"        => array(
                'title'     => __("Export tool", 'advanced-dynamic-pricing-for-woocommerce'),
                'templates' => array(
                    "export",
                ),
            ),
            "import"        => array(
                'title'     => __("Import tool", 'advanced-dynamic-pricing-for-woocommerce'),
                'templates' => array(
                    "import",
                ),
            ),
            "migration_rules"        => array(
                'title'     => __("Migrate rules", 'advanced-dynamic-pricing-for-woocommerce'),
                'templates' => array(
                    "migration_rules",
                ),
            ),
