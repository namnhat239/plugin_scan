...
?>
	<div data-<?php echo $assetTypeS; ?>-handle="<?php echo esc_attr($data['row']['obj']->handle); ?>" class="wpacu_asset_options_wrap wpacu_unload_regex_area_wrap">
		<ul class="wpacu_asset_options">
			<li>
				<label for="wpacu_unload_it_regex_option_<?php echo $assetTypeS; ?>_<?php echo esc_attr($data['row']['obj']->handle); ?>">
					<input data-handle="<?php echo esc_attr($data['row']['obj']->handle); ?>"
					       id="wpacu_unload_it_regex_option_<?php echo $assetTypeS; ?>_<?php echo esc_attr($data['row']['obj']->handle); ?>"
