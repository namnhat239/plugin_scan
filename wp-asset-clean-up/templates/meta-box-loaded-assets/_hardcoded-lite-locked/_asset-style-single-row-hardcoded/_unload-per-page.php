		...
		<li class="wpacu_unload_this_page">
			<label class="wpacu-manage-hardcoded-assets-requires-pro-popup wpacu_switch wpacu_disabled">
				<input data-handle="<?php echo esc_attr($data['row']['obj']->handle); ?>"
				       ...
				       id="style_<?php echo esc_attr($data['row']['obj']->handle); ?>"
                       disabled="disabled"
			...
			<label class="wpacu-manage-hardcoded-assets-requires-pro-popup wpacu_slider_text" for="style_<?php echo esc_attr($data['row']['obj']->handle); ?>">
