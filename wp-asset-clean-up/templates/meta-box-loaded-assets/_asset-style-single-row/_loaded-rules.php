...
?>
    ...
    ?>
        <div style="margin: 0 0 15px;">
            ...
            <div style="display: inline-block; vertical-align: middle; margin-left: -2px;"><a class="wpacu-media-query-load-requires-pro-popup" href="<?php echo WPACU_PLUGIN_GO_PRO_URL; ?>?utm_source=manage_asset&utm_medium=media_query_load_css"><img width="20" height="20" src="<?php echo esc_url(WPACU_PLUGIN_URL); ?>/assets/icons/icon-lock.svg" valign="top" alt="" /></a></div>
