            ...
            <tr>
                <td class="wpacu_plugin_icon" width="40">
					<?php if (isset($data['plugins_icons'][$pluginDir])) { ?>
						<img width="40" height="40" alt="" src="<?php echo esc_url($data['plugins_icons'][$pluginDir]); ?>" />
					<?php } else { ?>
                ...
                <td class="wpacu_plugin_details">
                    ...
                    <div class="wrap_plugin_unload_rules_options">
                                ...
                                <li>
                                    <label for="wpacu_global_unload_plugin_<?php echo esc_attr($pluginPath); ?>">
                                        ...
                                        <a class="go-pro-link-no-style"
                                           href="<?php echo WPACU_PLUGIN_GO_PRO_URL; ?>?utm_source=manage_asset&utm_medium=unload_plugin_site_wide"><span class="wpacu-tooltip" style="width: 200px; margin-left: -108px;">This feature is locked for Pro users<br />Click here to upgrade!</span><img width="20" height="20" src="<?php echo esc_url(WPACU_PLUGIN_URL); ?>/assets/icons/icon-lock.svg" valign="top" alt="" /></a>&nbsp; Unload in all frontend pages <small>&amp; add exceptions</small></label>
                                </li>
                            </ul>
                        </div>
                            ...
                            <ul class="wpacu_plugin_rules">
                                <li>
                                    <label for="wpacu_unload_it_regex_option_<?php echo esc_attr($pluginPath); ?>"
                                        ...
                                        <a class="go-pro-link-no-style"
                                           href="<?php echo WPACU_PLUGIN_GO_PRO_URL; ?>?utm_source=manage_asset&utm_medium=unload_plugin_via_regex"><span class="wpacu-tooltip" style="width: 200px; margin-left: -132px;">This feature is locked for Pro users<br />Click here to upgrade!</span><img width="20" height="20" src="<?php echo esc_url(WPACU_PLUGIN_URL); ?>/assets/icons/icon-lock.svg" valign="top" alt="" /></a> &nbsp;<span>Unload it for frontend URLs with request URI matching the RegEx(es):</span></label>
                        ...
                        <div class="wpacu_plugin_rules_wrap">
                            <ul class="wpacu_plugin_rules">
                                <li>
                                    <label for="wpacu_unload_it_logged_in_plugin_<?php echo esc_attr($pluginPath); ?>" style="margin-right: 0;">
                                        <input data-wpacu-plugin-path="<?php echo esc_attr($pluginPath); ?>"
                                               style="margin-right: 0;"
                                               disabled="disabled"
                                               id="wpacu_unload_it_logged_in_plugin_<?php echo esc_attr($pluginPath); ?>"
                                               class="disabled wpacu_plugin_unload_logged_in"
                                               type="checkbox"
                                               name="wpacu_plugins[<?php echo esc_attr($pluginPath); ?>][status][]"
                                               value="unload_logged_in" />
                                        <a class="go-pro-link-no-style"
                                           href="<?php echo WPACU_PLUGIN_GO_PRO_URL; ?>?utm_source=manage_asset&utm_medium=unload_plugin_if_logged_in"><span class="wpacu-tooltip" style="width: 200px; margin-left: -132px;">This feature is locked for Pro users<br />Click here to upgrade!</span><img width="20" height="20" src="<?php echo esc_url(WPACU_PLUGIN_URL); ?>/assets/icons/icon-lock.svg" valign="top" alt="" /></a> &nbsp;<span>Unload it in the frontend if the user is logged in</span>
                                    </label>
                                </li>
                            </ul>
                        </div>
