                                ...
                                <li>
                                    <label for="wpacu_global_unload_plugin_<?php echo esc_attr($pluginPath); ?>">
                                        ...
                                        <a class="go-pro-link-no-style"
                                           href="<?php echo WPACU_PLUGIN_GO_PRO_URL; ?>?utm_source=manage_asset&utm_medium=unload_plugin_all_pages_in_admin"><span class="wpacu-tooltip" style="width: 200px; margin-left: -108px;">This feature is locked for Pro users<br />Click here to upgrade!</span><img width="20" height="20" src="<?php echo esc_url(WPACU_PLUGIN_URL); ?>/assets/icons/icon-lock.svg" valign="top" alt="" /></a>&nbsp; Unload on all admin pages <small>&amp; add exceptions</small></label>
                                </li>
                            </ul>
                        </div>
                            ...
                            <ul class="wpacu_plugin_rules">
                                <li>
									<label for="wpacu_unload_it_regex_option_<?php echo esc_attr($pluginPath); ?>"
                                        ...
                                        <a class="go-pro-link-no-style"
                                           href="<?php echo WPACU_PLUGIN_GO_PRO_URL; ?>?utm_source=manage_asset&utm_medium=unload_plugin_via_regex_in_admin"><span class="wpacu-tooltip" style="width: 200px; margin-left: -136px;">This feature is locked for Pro users<br />Click here to upgrade!</span><img width="20" height="20" src="<?php echo esc_url(WPACU_PLUGIN_URL); ?>/assets/icons/icon-lock.svg" valign="top" alt="" /></a> &nbsp;<span>Unload it for admin URLs with request URI matching the RegEx(es):</span></label>
