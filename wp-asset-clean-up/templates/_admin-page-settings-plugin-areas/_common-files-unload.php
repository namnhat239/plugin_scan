        ...
        <tr valign="top">
            ...
            <td>
                ...
                <p style="margin-top: 10px;">
                    ...
                    <?php _e('While on some WordPress setups is useful, in many situations (especially when you are not using WordPress as a blog), you just don’t need them.', 'wp-asset-clean-up'); ?>
