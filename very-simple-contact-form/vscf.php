...
function vscf_get_the_ip() {
	if (isset($_SERVER["HTTP_X_FORWARDED_FOR"])) {
		return esc_attr($_SERVER["HTTP_X_FORWARDED_FOR"]);
	} elseif (isset($_SERVER["HTTP_CLIENT_IP"])) {
		return esc_attr($_SERVER["HTTP_CLIENT_IP"]);
	} else {
...
function vscf_from_header() {
	...
	if ( (strpos($server, 'http')) || (strpos($server, 'https')) || (strpos($server, 'www')) ) {
