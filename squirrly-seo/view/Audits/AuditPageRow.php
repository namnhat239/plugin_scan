...
<?php if ($view->auditpage->audit_error) { ?>
    <td>
        ...
        <button class="btn btn-sm btn-primary sq_previewurl font-weight-bold"  style="cursor: pointer" onclick="jQuery('#sq_previewurl_modal').attr('data-post_id', '<?php echo (int)$view->auditpage->user_post_id ?>');  jQuery('#sq_previewurl_modal').sq_inspectURL()" data-dismiss="modal"><?php echo esc_html__("Inspect URL", 'squirrly-seo'); ?></button>
