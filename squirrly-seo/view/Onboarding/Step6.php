                    ...
                    <div id="sq_onboarding" class="col-6 my-0 mx-auto p-0">
                        ...
                        <div class="col-12 row m-0 p-0 my-5">
                            <div class="col m-0 p-0 text-center">
                                <a href="post-new.php?post_type=post&keyword=<?php echo SQ_Classes_Helpers_Tools::getValue('keyword', '')?>"  class="btn btn-primary btn-lg m-0 p-0 py-2 px-4 rounded-0"><?php echo esc_html__("SEO Beginner: Start Here", 'squirrly-seo'); ?> > </a>
                            </div>
                            <div class="col m-0 p-0 text-center">
