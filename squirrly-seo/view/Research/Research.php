            ...
            <div class="flex-grow-1 sq_flex m-0 py-0 px-5">
                ...
                <div class="sq_step sq_step1 my-2">
                    ...
                    <div class="input-group col-12 m-0 px-0 py-5">
                        <input type="hidden" name="post_id" value="<?php echo SQ_Classes_Helpers_Tools::getValue('post_id') ?>">
                ...
                <div class="sq_step sq_step2 my-2" style="display: none;">
                    ...
                    <div class="sq_suggestions col-12 my-4 p-3 bg-white" style="min-height: 100px">
                        ...
                        <h4 class="sq_limit_exceeded text-danger text-center" style="display: none">
                            <?php echo esc_html__("You've reached your Keyword Research Limit", 'squirrly-seo') ?>
                        ...
                        <h4 class="sq_research_error text-primary text-center" style="display: none"><?php echo sprintf(esc_html__("We could not find similar keywords. %sClick on 'Do research'", 'squirrly-seo'), '<br />') ?></h4>
                    </div>
                ...
                <div class="sq_step sq_step3 col-12 my-2 px-0" style="display: none; min-height: 230px !important;">
