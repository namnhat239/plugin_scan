        ...
        <div class="d-flex flex-row flex-nowrap flex-grow-1 bg-light m-0 p-0">
            <div class="flex-grow-1 sq_flex m-0 py-0 px-5">
                ...
                <div class="col-7 small m-0 p-0 py-2">
                    <a href="https://howto12.squirrly.co/kb/keyword-research-and-seo-strategy/#briefcase" target="_blank"><?php echo esc_html__('See and add the exact keywords that drive people to your site.','squirrly-seo') ?></a>
                </div>
