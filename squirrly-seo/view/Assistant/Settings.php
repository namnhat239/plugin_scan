...
<div id="sq_wrap">
    ...
    <div id="sq_content" class="d-flex flex-row bg-white my-0 p-0 m-0">
        ...
        <div class="d-flex flex-row flex-nowrap flex-grow-1 bg-light m-0 p-0">
            <div class="flex-grow-1 sq_flex m-0 p-0 px-5">
                        ...
                        <div class="col-12 m-0 p-0">
                            <div class="col-12 m-0 p-0">
                                ...
                                <div class="col-12 m-0 p-0">
                                    <div class="col-12 row m-0 p-0">
                                        <div class="checker col-12 row my-4 p-0 mx-0">
                                            <div class="col-12 p-0 m-0 sq-switch sq-switch-sm">
                                                ...
                                                <label for="sq_keyword_help" class="ml-1"><?php echo esc_html__("Squirrly Tooltips", 'squirrly-seo'); ?>
                                                ...
                                                <div class="small text-black-50 ml-5"><?php echo sprintf(esc_html__("Show %sSquirrly Tooltips%s when posting a new article (e.g. 'Enter a keyword').", 'squirrly-seo'), '<strong>', '</strong>'); ?></div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <?php if (SQ_Classes_Helpers_Tools::isPluginInstalled('elementor/elementor.php') || SQ_Classes_Helpers_Tools::isPluginInstalled('oxygen/functions.php')) { ?>
                                        <div class="col-12 row m-0 p-0">
                                            <div class="checker col-12 row my-4 p-0 mx-0">
                                                <div class="col-12 p-0 m-0 sq-switch sq-switch-sm">
                                                    ...
                                                    <div class="small text-black-50 ml-5"><?php echo esc_html__("Currently supports Elementor Builder & Oxygen Builder plugins.", 'squirrly-seo'); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                    <?php }?>
                                ...
                                <div class="col-12 p-0 m-0 my-5 sq_advanced">
                                    <h3 class="card-title"><?php echo esc_html__("Places where you do NOT want Squirrly Live Assistant to load", 'squirrly-seo'); ?>
                                        <div class="sq_help_question d-inline">
                                            <a href="https://howto12.squirrly.co/kb/squirrly-live-assistant/#disable_live_assistant" target="_blank"><i class="fa-solid fa-question-circle"></i></a>
                                        </div>
                                    </h3>
                                    <div class="col-7 small m-0 p-0 text-danger">
                                        <?php echo esc_html__("Don't select anything if you wish Squirrly Live Assistant to load for all post types.", 'squirrly-seo'); ?>
                                    </div>
                                </div>
                                <div class="col-12 p-0 m-0 my-5 sq_advanced">
                                    <div class="col-12 row m-0 p-0">
