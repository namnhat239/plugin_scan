...
<div class="sq_features my-2 py-2">
    ...
    <div class="row row-cols-1 row-cols-md-3 p-0 m-0" style="max-width: 1200px;">
        ...
        <?php }?>
   <?php }else{ ?>
        <div class="row text-left m-0 p-0" style="max-width: 500px;">
                ...
                <div class="col-12 m-2 p-0">
                    <div class="row py-2">
                        <form method="get" class="d-flex flex-row flex-grow-1 justify-content-end m-0 p-0">
                            ...
                            <input type="search" class="d-inline-block align-middle col m-0 p-0 px-1 rounded-0" autofocus name="sfeature" placeholder="<?php echo esc_html__("Enter a feature you want to search for", 'squirrly-seo') ?>" value="<?php echo SQ_Classes_Helpers_Sanitize::escapeKeyword(SQ_Classes_Helpers_Tools::getValue('sfeature')) ?>"/>
                            <?php if (SQ_Classes_Helpers_Tools::getIsset('sfeature')) { ?>
