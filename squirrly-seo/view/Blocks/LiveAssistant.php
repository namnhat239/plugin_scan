...
<div class="sq_box" style="display: none">
    ...
    <div id="sq_errorloading" class="sq-p-2 sq-py-3 sq-bg-light sq-border-bottom" style="display: none">
        <?php echo sprintf(esc_html__("Connection error with Squirrly Cloud. Please check the connection and %s refresh the page %s", 'squirrly-seo'),'<a href="javascript:location.reload();">','</a>'); ?>
    </div>
