...
class SQ_Models_Focuspages_Traffic extends SQ_Models_Abstract_Assistant
{
    ...
    public function getHeader()
    {
        ...
        if (!$this->_audit->sq_analytics_gsc_connected) {
            $header .= '<li class="completed">
                    <a href="' . SQ_Classes_RemoteController::getApiLink('gscoauth') . '"  target="_blank" class="btn btn-primary text-white col-10 offset-1 mt-1">' . esc_html__("Connect Google Search", 'squirrly-seo') . '</a>
                </li>';
        }
        if (!$this->_audit->sq_analytics_google_connected) {
            $header .= '<li class="completed">
                    <a href="' . SQ_Classes_RemoteController::getApiLink('gaoauth') . '"  target="_blank" class="btn btn-primary text-white col-10 offset-1 mt-1">' . esc_html__("Connect Google Analytics", 'squirrly-seo') . '</a>
                </li>';
        }
        return $header;
    }
