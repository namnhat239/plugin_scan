    ...
    public function getHeader()
    {
        ...
        if (isset($this->_post->ID)) {
            ...
            if (!$this->_audit->sq_analytics_google_connected) {
                $header .= '<a href="' . SQ_Classes_RemoteController::getApiLink('gaoauth') . '"  target="_blank" class="btn btn-primary text-white col-10 offset-1 mt-1">' . esc_html__("Connect Google Analytics", 'squirrly-seo') . '</a>';
            }
            $header .= '</li>';
