    ...
    public function setTasks($tasks)
    {
        ...
        $this->_tasks[$this->_category] = array(
            'sitemap' => array(
                ...
                'description' => sprintf(esc_html__("Add images / videos to your sitemap. It's important to have images / videos enabled. %s Squirrly SEO makes it super easy for you to enhance your XML sitemap. %s Just use the settings from %s Squirrly > SEO Configuration > Tweaks And Sitemap %s. Find the XML sitemap section and use the settings from that panel. ", 'squirrly-seo'), '<br /><br />', '<br /><br />', '<a href="' . SQ_Classes_Helpers_Tools::getAdminUrl('sq_seosettings', 'tweaks', array('#tab=sitemap')) . '" target="_blank" >', '</a>'),
            ),
            'posttype' => array(
