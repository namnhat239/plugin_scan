...
class Color {
    ...
    function __construct( $hex ) {
        ...
        if( strlen($color) === 3 ) {
            ...
            throw new Exception(esc_html__('HEX color needs to be 6 or 3 digits long', 'ds-icon-expansion'));
        }
    ...
    public static function hslToHex( $hsl = array() ){
        ...
        if(empty($hsl) || !isset($hsl["H"]) || !isset($hsl["S"]) || !isset($hsl["L"]) ) {
            throw new Exception( esc_html__('Param was not an HSL array', 'ds-icon-expansion'));
        }
    ...
    public static function rgbToHex( $rgb = array() ){
        ...
        if(empty($rgb) || !isset($rgb["R"]) || !isset($rgb["G"]) || !isset($rgb["B"]) ) {
            throw new Exception( esc_html__('Param was not an RGB array', 'ds-icon-expansion'));
        }
