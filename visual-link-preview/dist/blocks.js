...
var Sidebar_Component = wp.element.Component; // Backwards compatibility.
    ...
    value: function getContent(attributes) {
      ...
      this.setState({
        ...
        Api.old.getContent(attributes.type, value).then(function (_ref) {
          ...
          _this2.props.setAttributes(edit_objectSpread({}, data)); // Prevent issue with block using old data.
...
var registerBlockType = wp.blocks.registerBlockType; // Backwards compatibility.
