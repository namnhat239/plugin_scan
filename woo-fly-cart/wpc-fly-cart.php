...
! defined( 'WOOFC_VERSION' ) && define( 'WOOFC_VERSION', '4.3.2' );
		...
		if ( ! class_exists( 'WPCleverWoofc' ) && class_exists( 'WC_Product' ) ) {
			class WPCleverWoofc {
				...
				function enqueue_scripts() {
					...
					$inline_css = ".woofc-area.woofc-style-01, .woofc-area.woofc-style-03, .woofc-area.woofc-style-02 .woofc-area-bot .woofc-action .woofc-action-inner > div a:hover, .woofc-area.woofc-style-04 .woofc-area-bot .woofc-action .woofc-action-inner > div a:hover {
				...
				function update_shipping_method() {
					...
					$posted_shipping_methods = isset( $_POST['shipping_methods'] ) ? wc_clean( wp_unslash( $_POST['shipping_methods'] ) ) : array();
				...
				function get_cart_area() {
					...
					if ( ! empty( $items ) ) {
						...
						if ( get_option( '_woofc_buttons', '01' ) === '01' ) {
							// both buttons
							$cart_html .= '<div class="woofc-action"><div class="woofc-action-inner"><div class="woofc-action-left"><a href="' . wc_get_cart_url() . '">' . self::localization( 'cart', esc_html__( 'Cart', 'woo-fly-cart' ) ) . '</a></div><div class="woofc-action-right"><a href="' . wc_get_checkout_url() . '">' . self::localization( 'checkout', esc_html__( 'Checkout', 'woo-fly-cart' ) ) . '</a></div></div></div>';
						} else {
							if ( get_option( '_woofc_buttons', '01' ) === '02' ) {
								// cart
								$cart_html .= '<div class="woofc-action"><div class="woofc-action-inner"><div class="woofc-action-full"><a href="' . wc_get_cart_url() . '">' . self::localization( 'cart', esc_html__( 'Cart', 'woo-fly-cart' ) ) . '</a></div></div></div>';
							}

							if ( get_option( '_woofc_buttons', '01' ) === '03' ) {
								// checkout
								$cart_html .= '<div class="woofc-action"><div class="woofc-action-inner"><div class="woofc-action-full"><a href="' . wc_get_checkout_url() . '">' . self::localization( 'checkout', esc_html__( 'Checkout', 'woo-fly-cart' ) ) . '</a></div></div></div>';
							}
						}
					}
