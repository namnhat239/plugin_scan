...
define( 'VI_WNOTIFICATION_F_VERSION', '1.2.9' );
/**
	...
	function global_note() {
		if ( ! is_plugin_active( 'woocommerce/woocommerce.php' ) ) {
			...
			<div id="message" class="error">
				<p><?php esc_html_e( 'Please install and activate WooCommerce to use Notification for WooCommerce plugin.', 'woo-notification' ); ?></p>
			</div>
			<?php
		}
	}
