...
class Style {
	...
	public static function name( $obj ) {
		...
		$obj->elHeading( $obj->elPrefix . 'name_colors_note', __( 'Colors', 'tlp-team' ), 'before' );

		$obj->startTabGroup( 'name_color_tabs' );
		$obj->startTab( 'name_color_tab', __( 'Normal', 'tlp-team' ) );
		...
		$obj->elControls[] = [
			...
			'label'     => __( 'Background Color', 'tlp-team' ),
			'selectors' => [
		...
		$obj->elControls[] = [
			...
			'label'     => __( 'Top Title Color', 'tlp-team' ),
		...
		$obj->elControls[] = [
			...
			'label'     => __( 'Top Title Background Color', 'tlp-team' ),
			'condition' => [ $obj->elPrefix . 'layout' => [ 'layout-el-10', 'carousel5' ] ],
			'selectors' => [
		...
		$obj->elControls[] = [
			...
			'label'     => __( 'Inner Background Color', 'tlp-team' ),
		...
		$obj->endTab();
		$obj->startTab( 'name_hover_color_tab', __( 'Hover', 'tlp-team' ) );
		...
		$obj->elControls[] = [
			...
			'label'     => __( 'Hover Background Color', 'tlp-team' ),
			'selectors' => [
		...
		$obj->elControls[] = [
			...
			'label'     => __( 'Top Hover Color', 'tlp-team' ),
			'selectors' => [
		...
		$obj->elControls[] = [
			...
			'label'     => __( 'Top Hover Background Color', 'tlp-team' ),
			'condition' => [ $obj->elPrefix . 'layout' => [ 'layout10', 'carousel5' ] ],
			'selectors' => [
		...
		$obj->elHeading( $obj->elPrefix . 'name_border_note', __( 'Border', 'tlp-team' ), 'before' );

		$obj->elControls[] = [
			'mode'     => 'group',
			'type'     => 'border',
			'label'    => __( 'Border', 'tlp-team' ),
		...
		$obj->elHeading( $obj->elPrefix . 'name_spacing_note', __( 'Spacing', 'tlp-team' ), 'before' );

		$obj->elControls[] = [
			'mode'       => 'responsive',
			'type'       => 'dimensions',
			'id'         => $obj->elPrefix . 'name_padding',
			'label'      => __( 'Padding', 'tlp-team' ),
			'size_units' => [ 'px', '%', 'em' ],
			'selectors'  => [
		...
		$obj->elControls[] = [
			...
			'label'      => __( 'Top Title Padding', 'tlp-team' ),
			'size_units' => [ 'px', '%', 'em' ],
			'condition'  => [ $obj->elPrefix . 'layout' => [ 'layout10', 'carousel5' ] ],
			'selectors'  => [
	...
	public static function designation( $obj ) {
		...
		$obj->elHeading( $obj->elPrefix . 'designation_typography_note', __( 'Typography', 'tlp-team' ) );
		...
		$obj->elHeading( $obj->elPrefix . 'designation_colors_note', __( 'Colors', 'tlp-team' ), 'before' );

		$obj->startTabGroup( 'designation_color_tabs' );
		$obj->startTab( 'designation_color_tab', __( 'Normal', 'tlp-team' ) );
		...
		$obj->endTab();
		$obj->startTab( 'designation_hover_color_tab', __( 'Hover', 'tlp-team' ) );
		...
		$obj->elHeading( $obj->elPrefix . 'designation_border_note', __( 'Border', 'tlp-team' ), 'before' );
		...
		$obj->elHeading( $obj->elPrefix . 'designation_spacing_note', __( 'Spacing', 'tlp-team' ), 'before' );
	...
	public static function department( $obj ) {
		...
		$obj->elHeading( $obj->elPrefix . 'department_typography_note', __( 'Typography', 'tlp-team' ) );
		...
		$obj->elHeading( $obj->elPrefix . 'department_colors_note', __( 'Colors', 'tlp-team' ), 'before' );

		$obj->startTabGroup( 'department_color_tabs' );
		$obj->startTab( 'department_color_tab', __( 'Normal', 'tlp-team' ) );
		...
		$obj->endTab();
		$obj->startTab( 'department_hover_color_tab', __( 'Hover', 'tlp-team' ) );
		...
		$obj->elHeading( $obj->elPrefix . 'department_border_note', __( 'Border', 'tlp-team' ), 'before' );
		...
		$obj->elHeading( $obj->elPrefix . 'department_spacing_note', __( 'Spacing', 'tlp-team' ), 'before' );
	...
	public static function short_biography( $obj ) {
		...
		$obj->elHeading( $obj->elPrefix . 'short_biography_typography_note', __( 'Typography', 'tlp-team' ) );
		...
		$obj->elHeading( $obj->elPrefix . 'short_biography_colors_note', __( 'Colors', 'tlp-team' ), 'before' );

		$obj->startTabGroup( 'short_biography_color_tabs' );
		$obj->startTab( 'short_biography_color_tab', __( 'Normal', 'tlp-team' ) );
		...
		$obj->endTab();
		$obj->startTab( 'short_biography_hover_color_tab', __( 'Hover', 'tlp-team' ) );
		...
		$obj->elHeading( $obj->elPrefix . 'short_biography_border_note', __( 'Border', 'tlp-team' ), 'before' );
		...
		$obj->elHeading( $obj->elPrefix . 'short_biography_spacing_note', __( 'Spacing', 'tlp-team' ), 'before' );
	...
	public static function buttons( $obj ) {
		...
		$obj->elHeading( $obj->elPrefix . 'buttons_typography_note', __( 'Arrow Size', 'tlp-team' ), 'null', [], $arrow_condition );

		$obj->elControls[] = [
			'type'      => 'slider',
			'mode'      => 'responsive',
			'id'        => $obj->elPrefix . 'arrow_size',
			'label'     => __( 'Arrow Size', 'tlp-team' ),
			'range'     => [
				'px' => [
					'min'  => 1,
					'max'  => 100,
		...
		$obj->elControls[] = [
			...
			'label'     => __( 'Arrow Height', 'tlp-team' ),
			'range'     => [
				'px' => [
					'min'  => 1,
					'max'  => 100,
		...
		$obj->elHeading( $obj->elPrefix . 'dot_size_note', __( 'Dot Size', 'tlp-team' ), 'before', [], $dot_condition );

		$obj->elControls[] = [
			'type'      => 'slider',
			'mode'      => 'responsive',
			'id'        => $obj->elPrefix . 'dot_width',
			'label'     => __( 'Dot Width', 'tlp-team' ),
			'range'     => [
				'px'  => [
					'min'  => 1,
					'max'  => 100,
		...
		$obj->elHeading( $obj->elPrefix . 'buttons_colors_note', __( 'Colors', 'tlp-team' ), 'before' );

		$obj->startTabGroup( 'button_color_tabs' );
		$obj->startTab( 'button_color_tab', __( 'Normal', 'tlp-team' ) );
		...
		$obj->endTab();
		$obj->startTab( 'button_hover_color_tab', __( 'Hover', 'tlp-team' ) );
		...
		$obj->endTab();
		$obj->startTab( 'button_active_color_tab', __( 'Active', 'tlp-team' ), [], $dot_condition );

		$obj->elControls[] = [
			'type'      => 'color',
			'id'        => $obj->elPrefix . 'button_active_bg_color',
			'label'     => __( 'Active Background Color', 'tlp-team' ),
			'selectors' => [
		...
		$obj->elControls[] = [
			...
			'label'     => __( 'Active Border Color', 'tlp-team' ),
			'selectors' => [
		...
		$obj->elHeading( $obj->elPrefix . 'buttons_spacing_note', __( 'Spacing', 'tlp-team' ), 'before' );

		$obj->elControls[] = [
			'mode'       => 'responsive',
			'type'       => 'dimensions',
			'id'         => $obj->elPrefix . 'buttons_wrapper_padding',
			'label'      => __( 'Wrapper Padding', 'tlp-team' ),
			'size_units' => [ 'px', '%', 'em' ],
			'selectors'  => [
	...
	public static function imageStyle( $obj ) {
		...
		$obj->elControls[] = [
			...
			'label'      => __( 'Border Radius', 'tlp-team' ),
			'size_units' => [ 'px', '%' ],
			'default'    => [
				'unit'     => '%',
				'isLinked' => true,
	...
	public static function pagination( $obj ) {
		...
		$obj->elHeading( $obj->elPrefix . 'buttons_typography_note', __( 'Typography', 'tlp-team' ) );
		...
		$obj->endTab();
		$obj->startTab( 'button_active_color_tab', __( 'Active', 'tlp-team' ), [], $activeCondition );

		$obj->elControls[] = [
			'type'      => 'color',
			'id'        => $obj->elPrefix . 'button_active_color',
			'label'     => __( 'Active Color', 'tlp-team' ),
			'selectors' => [
		...
		$obj->elHeading( $obj->elPrefix . 'buttons_border_note', __( 'Border', 'tlp-team' ), 'before' );
	...
	public static function filterButtons( $obj ) {
		$obj->startSection(
			...
			esc_html__( 'Filter Button', 'tlp-team-pro' ),
			\Elementor\Controls_Manager::TAB_STYLE,
			[],
			[ $obj->elPrefix . 'enable_isotope_button' => [ 'yes' ] ]
		);

		$obj->elHeading( $obj->elPrefix . 'filter_buttons_typography_note', __( 'Typography', 'tlp-team-pro' ) );
		...
		$obj->elHeading( $obj->elPrefix . 'filter_buttons_colors_note', __( 'Colors', 'tlp-team-pro' ), 'before' );

		$obj->startTabGroup( 'filter_button_color_tabs' );
		$obj->startTab( 'filter_button_color_tab', __( 'Normal', 'tlp-team-pro' ) );

		$obj->elControls[] = [
			'type'      => 'color',
			'id'        => $obj->elPrefix . 'filter_button_color',
			'label'     => __( 'Button Color', 'tlp-team-pro' ),
			'selectors' => [
		...
		$obj->elControls[] = [
			...
			'label'     => __( 'Button Background Color', 'tlp-team-pro' ),
			'selectors' => [
		...
		$obj->endTab();
		$obj->startTab( 'filter_button_hover_color_tab', __( 'Hover', 'tlp-team-pro' ) );

		$obj->elControls[] = [
			'type'      => 'color',
			'id'        => $obj->elPrefix . 'filter_button_hover_color',
			'label'     => __( 'Hover Color', 'tlp-team-pro' ),
			'selectors' => [
		...
		$obj->elControls[] = [
			...
			'label'     => __( 'Hover Background Color', 'tlp-team-pro' ),
			'selectors' => [
		...
		$obj->endTab();
		$obj->startTab( 'filter_button_active_color_tab', __( 'Active', 'tlp-team-pro' ) );

		$obj->elControls[] = [
			'type'      => 'color',
			'id'        => $obj->elPrefix . 'filter_button_active_color',
			'label'     => __( 'Active Color', 'tlp-team-pro' ),
			'selectors' => [
		...
		$obj->elControls[] = [
			...
			'label'     => __( 'Active Background Color', 'tlp-team-pro' ),
			'selectors' => [
		...
		$obj->elHeading( $obj->elPrefix . 'filter_buttons_border_note', __( 'Border', 'tlp-team-pro' ), 'before' );
		...
		$obj->elControls[] = [
			...
			'label'     => __( 'Hover Border Color', 'tlp-team-pro' ),
		...
		$obj->elControls[] = [
			...
			'label'     => __( 'Active Border Color', 'tlp-team-pro' ),
			'condition' => [ $obj->elPrefix . 'filter_button_border_border!' => [ '' ] ],
			'selectors' => [
		...
		$obj->elControls[] = [
			...
			'label'      => __( 'Border Radius', 'tlp-team-pro' ),
			'size_units' => [ 'px', '%' ],
			'default'    => [
				'unit'     => 'px',
				'isLinked' => true,
		...
		$obj->elHeading( $obj->elPrefix . 'filter_buttons_spacing_note', __( 'Spacing', 'tlp-team-pro' ), 'before' );

		$obj->elControls[] = [
			'mode'       => 'responsive',
			'type'       => 'dimensions',
			'id'         => $obj->elPrefix . 'filter_buttons_wrapper_padding',
			'label'      => __( 'Wrapper Padding', 'tlp-team-pro' ),
			'size_units' => [ 'px', '%', 'em' ],
			'selectors'  => [
