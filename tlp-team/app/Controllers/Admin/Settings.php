...
class Settings {
	...
	protected function init() {
		...
		add_action( 'admin_menu', array( $this, 'tlp_menu_register' ), 15 );

		add_filter( 'plugin_action_links_' . plugin_basename( TLP_TEAM_PLUGIN_ACTIVE_FILE_NAME ), array( $this, 'marketing' ) );
	}
	 ...
	 * @return void|string
	 */
	public function tlp_team_export_import() {
		Fns::render_view( 'export-import' );
	}
