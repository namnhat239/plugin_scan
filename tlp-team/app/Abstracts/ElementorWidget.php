	...
	public function promoContent( $fields ) {
		...
		$promoFields[] = [
			...
			'label' => sprintf(
				...
				__( 'Go Premium for More Features', 'tlp-team' )
			),
		...
		$promoFields[] = [
			...
			'id'   => 'rttm_el_get_pro',
			'raw'  => '<div class="elementor-nerd-box"><div class="elementor-nerd-box-title" style="margin-top: 0; margin-bottom: 20px;">Unlock more possibilities</div><div class="elementor-nerd-box-message"><span class="pro-feature" style="font-size: 13px;"> Get the <a href="https://www.radiustheme.com/downloads/tlp-team-pro-for-wordpress/" target="_blank" style="color: #f54">Pro version</a> for more stunning layouts and customization options.</span></div><a class="elementor-nerd-box-link elementor-button elementor-button-default elementor-button-go-pro" href="https://www.radiustheme.com/downloads/tlp-team-pro-for-wordpress/" target="_blank">Get Pro</a></div>',
		];
