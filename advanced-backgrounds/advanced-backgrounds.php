...
class NK_AWB {
    ...
    public function register_scripts() {
        ...
        wp_register_script( 'nk-awb', nk_awb()->plugin_url . 'assets/awb/awb.min.js', array( 'jquery', 'jarallax', 'jarallax-video' ), '1.8.1', true );
        ...
        wp_register_style( 'nk-awb', nk_awb()->plugin_url . 'assets/awb/awb.min.css', '', '1.8.1' );
    }
