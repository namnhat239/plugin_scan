...
function ect_shortcode_attr()
{
      ...
      <li><strong>grid-view</strong> (<a href="'.esc_attr('https://eventscalendartemplates.com/events-grid-demo/').'" target="_blank">Premium Template</a>)</li>
      <li><strong>carousel-view</strong> (<a href="="'.esc_attr('https://eventscalendartemplates.com/events-carousel-demo/#top').'" target="_blank">Premium Template</a>)</li>
      <li><strong>slider-view</strong> (<a href="'.esc_attr('https://eventscalendartemplates.com/events-slider-demo/').'" target="_blank">Premium Template</a>)</li>
      <li><strong>accordion-view</strong> (<a href="'.esc_attr('https://eventscalendartemplates.com/events-accordion-demo/').'" target="_blank">Premium Template</a>)</li>
      </ul></td></tr>
