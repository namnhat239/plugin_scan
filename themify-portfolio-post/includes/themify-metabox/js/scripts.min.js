...
h.pagination(a("body"));h.audioRemoveAction();h.builder_page()},init_metabox_tabs:function(){a(".themify-meta-box-tabs").each(function(){var c=a(this),b=a(".ilc-htabs li",c);1<b.length?ThemifyTabs({ilctabs:"#"+c.attr("id")}):(a(".ilc-tab",c).show(),b.addClass("select"))});a(".ilc-htabs a").on("click",function(){h.set_cookie("themify-builder-tabs",a(this).attr("id"))});"undefined"!=typeof h.get_cookie("themify-builder-tabs")&&null!==h.get_cookie("themify-builder-tabs")&&a("#"+h.get_cookie("themify-builder-tabs")).trigger("click")},
...
b.find(".plupload-upload-uic").each(function(){themify_create_pluploader(a(this))});h.init_fields(c.find(".themify-repeater-row:last-child"))}).on("click",".themify-repeater-remove-row",function(c){c.preventDefault();a(this).parent().remove()})},audioRemoveAction:function(){a("body").on("click","[data-audio-remove] a",function(c){c.preventDefault();var b=a(this).parent();c=b.data("audio-remove");var d=function(){b.parent().find(".themify_upload_field").val("");b.addClass("hide")};d();c.action="themify_remove_audio";
