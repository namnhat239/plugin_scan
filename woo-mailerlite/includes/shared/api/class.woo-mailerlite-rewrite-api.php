...
class RewriteAPI
{
    ...
    public function replaceProductCategories( $shop_id, $product_id, $categories)
    {
        ...
        $response = $this->client->remote_put('/ecommerce/shops/' . $shop_id . '/products/' . $product_id . '/categories/multiple/multiple?with_resource_id', [
            'replace' => true,
            'categories' => $categories
        ]);
    ...
    public function importProducts( $shop_id, $products )
    {
        ...
        $response = $this->client->remote_post('/ecommerce/shops/' . $shop_id . '/products/import?with_resource_id', $products);
