...
Y=(a,f,e)=>{var d="";a="tf_video_"+a;e&&(d=new Date,d.setTime(d.getTime()+864E5*e),d=";expires="+d.toUTCString());b.cookie=a+"="+(f||"")+d+"; path=/"},ca=a=>{const f=b.createDocumentFragment();var e=W(a);const d=n.hash(a.currentSrc.split(".").slice(0,-1).join("."));var k=X("vol_"+d)||-1;const l=b.createElement("div"),m=a.parentNode,r=b.createElement("div"),G=b.createElement("div"),B=b.createElement("div"),t=b.createElement("div"),g=b.createElement("div"),q=b.createElement("div"),F=b.createElement("div"),
...
this.muted||0===this.volume?x.classList.add("tf_muted"):x.classList.remove("tf_muted");Y("vol_"+d,this.volume,120)},{passive:!0}),x.addEventListener(y,()=>{a.muted=!a.muted;a.muted||0!==a.volume||(A.value=50,n.triggerEvent(A,"input"))},{passive:!0}),x.appendChild(w("fas-volume-up","tf_abs_t")),x.appendChild(w("fas-volume-mute","tf_abs_t tf_h")),g.appendChild(x),A.min=0,A.max=100,A.type="range",A.value=-1<k?100*k:50,q.className="tf_video_volumn_inner",A.className="tf_video_volumn_range tf_h tf_overflow",
g.className="tf_video_volumn_wrap tf_rel",x.className="tf_video_mute tf_rel tf_overflow",a.muted&&(x.className+=" tf_muted"),q.appendChild(A),g.appendChild(q),F.appendChild(g));!a.hasAttribute("disablePictureInPicture")&&b.pictureInPictureEnabled&&(k=b.createElement("button"),k.addEventListener(y,aa,{passive:!0}),k.className="tf_video_pip",a.addEventListener("enterpictureinpicture",()=>{parentCl.add("tf_is_pip")},{passive:!0}),a.addEventListener("leavepictureinpicture",()=>{parentCl.remove("tf_is_pip")},
