							...
							<div class="inside">
								<table class="form-table">
									<tbody>
										...
										<tr>
											<th>
												<label><?php _e('Documentation', 'album-and-image-gallery-plus-lightbox'); ?>:</label>
											</th>
											<td>
												<a class="button button-primary" href="https://docs.essentialplugin.com/album-and-image-gallery-plus-lightbox/" target="_blank"><?php _e('Check Documentation', 'album-and-image-gallery-plus-lightbox'); ?></a>
											</td>
										</tr>
										
										<tr>
											<th>
												<label><?php _e('Demo', 'album-and-image-gallery-plus-lightbox'); ?>:</label>
											</th>
											<td>
												<a class="button button-primary" href="https://demo.essentialplugin.com/album-and-image-gallery-plus-lightbox-demo/" target="_blank"><?php _e('Check Free Demo', 'album-and-image-gallery-plus-lightbox'); ?></a>
											</td>
										</tr>
				...
				<div id="postbox-container-1" class="postbox-container">
					<div class="meta-box-sortables">
						<div class="postbox wpos-pro-box">
							<h3 class="hndle">
								<span><?php _e( 'Album and Gallery Premium Features', 'album-and-image-gallery-plus-lightbox' ); ?></span>
							</h3>
							<div class="inside">
								<ul class="wpos-list">
									...
									<li><?php _e( 'Fusion Page Builder (Avada) native support <em class="wpos-new-feature">New</em> <span>', 'album-and-image-gallery-plus-lightbox'); ?></li>
								...
								<a class="button button-primary wpos-button-full button-orange" href="<?php echo AIGPL_PLUGIN_LINK_UPGRADE; ?>" target="_blank"><?php _e('Grab Album Gallery Now', 'album-and-image-gallery-plus-lightbox'); ?></a>
							</div><!-- .inside -->
						</div><!-- #general -->
					</div><!-- .meta-box-sortables -->
