...
<div class="wrap">
	...
	<h2><?php _e( 'Album and Image Gallery Plus Lightbox', 'album-and-image-gallery-plus-lightbox' ); ?></h2>
	...
	<div id="poststuff">
		<div id="post-body" class="metabox-holder">
			<div id="post-body-content">
				<h3 style="text-align:center"><?php _e( 'Compare "Album and Image Gallery Plus Lightbox" Free VS Pro', 'album-and-image-gallery-plus-lightbox' ); ?></h3>
				<table class="wpos-plugin-pricing-table">
					...
					<thead>
						<tr>
							...
							<th>
								...
								<a href="<?php echo AIGPL_PLUGIN_LINK_UPGRADE; ?>" target="_blank">Buy Now</a>
							</th>
						</tr>
					</thead>
					...
					<tfoot>
						<tr>
							...
							<td>
							<h3 class="wpos-deal-heading">Choose best pricing in <span class="h-blue"> Annual</span> OR <span class="h-blue">Lifetime</span> deal</h3>
							<a href="<?php echo AIGPL_PLUGIN_LINK_UPGRADE; ?>" class="wpos-button" target="_blank">Buy Now</a></td>
						</tr>
					</tfoot>
