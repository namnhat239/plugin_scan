...
class Aigpl_Admin {
	...
	function __construct() {
		...
		add_action( 'admin_init', array($this, 'aigpl_admin_init_sf_process') );
	 ...
	 * @since 2.0.11
	 */
	function aigpl_admin_init_sf_process() {

		if ( get_option( 'aigpl_sf_optin', false ) ) {

			delete_option( 'aigpl_sf_optin' );

			$redirect_link = add_query_arg( array('post_type' => AIGPL_POST_TYPE, 'page' => 'aigpl-solutions-features' ), admin_url( 'edit.php' ) );
