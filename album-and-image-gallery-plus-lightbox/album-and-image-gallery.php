...
if( ! defined( 'AIGPL_VERSION' ) ) {
	define( 'AIGPL_VERSION', '1.5.8' ); // Version of plugin
}
...
if( ! defined( 'AIGPL_PLUGIN_LINK_UPGRADE' ) ) {
	define('AIGPL_PLUGIN_LINK_UPGRADE','https://www.essentialplugin.com/wordpress-plugin/album-image-gallery-plus-lightbox/?utm_source=WP&utm_medium=Album-Gallery&utm_campaign=Upgrade-PRO#wpos-epb'); // Plugin Check link
}

if(!defined( 'AIGPL_SITE_LINK' ) ) {
	define('AIGPL_SITE_LINK','https://www.essentialplugin.com'); // Plugin link
}
