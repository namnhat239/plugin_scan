...
<div class="label">ファイル情報</div>
<div id="fileinfo" class="information">
<p>ファイル名：<span id="filename"></span></p>
<p>タイプ：<span id="mode"></span></p>
<p>データ数：<span id="rowcount"></span></p>
<p>1行目：<span id="header"></span></p>
</div>
...
<?php
$progressfile = WP_CONTENT_DIR . USCES_UPLOAD_TEMP . '/progress.txt';
...
(function($) {
	...
	checkPRG = {
		settings: {
			url: '<?php echo( USCES_WP_PLUGIN_URL . '/' . USCES_PLUGIN_FOLDER . '/functions/progress-check.php?progressfile=' . rawurlencode( $progressfile ) ); ?>',
			type: 'GET',
			dataType: 'json',
			cache: false
		},
