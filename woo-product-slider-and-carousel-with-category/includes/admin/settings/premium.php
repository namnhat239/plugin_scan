...
<div class="wrap">
	...
	<h2><?php _e( 'Product Slider and Carousel with Category for WooCommerce', 'woo-product-slider-and-carousel-with-category' ); ?></h2>
	...
	<div id="poststuff">
		<div id="post-body" class="metabox-holder">
			<div id="post-body-content">
				<h3 style="text-align:center"><?php _e( 'Compare "Product Slider and Carousel with Category for WooCommerce" Free VS Pro', 'woo-product-slider-and-carousel-with-category' ); ?></h3>
					...
					<colgroup></colgroup>
						...
						<tr>
							...
							<th>
								...
								<a href="<?php echo WCPSCWC_PLUGIN_LINK_UPGRADE; ?>" target="_blank">Buy Now</a>
							</th>
						</tr>
					</thead>
					 ...
					 <tfoot>
						<tr>
							...
							<td>
							<h3 class="wpos-deal-heading">Choose best pricing in <span class="h-blue"> Annual</span> or <span class="h-blue">Lifetime</span> deal</h3>
							<a href="<?php echo WCPSCWC_PLUGIN_LINK_UPGRADE; ?>" target="_blank">Buy Now</a></td>
						</tr>
					</tfoot>
