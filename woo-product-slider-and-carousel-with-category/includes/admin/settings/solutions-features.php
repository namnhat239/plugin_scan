	...
	<div class="wcpscwc-sf-wrap">
		<div class="wcpscwc-sf-inr">
			...
			<div class="wcpscwc-sf-features-section wcpscwc-sf-team wcpscwc-sf-center">
				<h1 class="wcpscwc-sf-heading">Now get best value from <span class="wcpscwc-sf-blue">Annual</span> OR <span class="wcpscwc-sf-blue">Lifetime</span> deal</h1>
				...
				<h2>With <span class="wcpscwc-sf-blue">35+ plugins</span>, <span class="wcpscwc-sf-blue">2000+ templates</span> & $600 saving in <span class="wcpscwc-sf-blue">Essential Plugin Bundle</span></h2>
				<a href="<?php echo WCPSCWC_PLUGIN_BUNDLE_LINK; ?>"  target="_blank" class="wcpscwc-sf-btn wcpscwc-sf-btn-orange"><span class="dashicons dashicons-cart"></span> Grab Now This Deal</a>
			</div>
			<div class="wcpscwc-sf-features-section wcpscwc-sf-team wcpscwc-sf-center">
					<h1 class="wcpscwc-sf-heading">Powerful Team Behind <span class="wcpscwc-sf-blue">Product Slider and Carousel</span></h1>
						...
						<p></p>
						<div class="wcpscwc-sf-cont">This is why I wanted to introduce you to <span class="wcpscwc-sf-blue">Anoop Ranawat & Team</span> at EssentialPlugin.com</div>
						<img class="wcpscwc-sf-image" src="<?php echo WCPSCWC_URL; ?>/assets/images/wpos-team.png" alt="wpos team" />
				</div>
			...
			<div class="wcpscwc-sf-welcome-wrap">
				<div class="wcpscwc-sf-welcome-inr wcpscwc-sf-center">					
						...
						<a href="<?php echo esc_url( $wcpscwc_add_link ); ?>" class="wcpscwc-sf-btn">Launch Product Slider and Carousel With Free Features</a> <br /><b>OR</b> <br /> <a href="<?php echo WCPSCWC_PLUGIN_BUNDLE_LINK; ?>"  target="_blank" class="wcpscwc-sf-btn wcpscwc-sf-btn-orange"> <span class="dashicons dashicons-cart"></span> Grab Now With Essential Bundle</a>
			...
			<div class="wcpscwc-features-section">
				...
				<div class="wcpscwc-sf-welcome-wrap wcpscwc-sf-center">
					...
					<a href="<?php echo WCPSCWC_PLUGIN_BUNDLE_LINK; ?>" target="_blank" class="wcpscwc-sf-btn wcpscwc-sf-btn-orange"><span class="dashicons dashicons-cart"></span> Grab Now With Essential Bundle</a>
					<div class="wcpscwc-rc-wrap">
						<div class="wcpscwc-rc-inr wcpscwc-rc-bg-box">
							<div class="wcpscwc-rc-icon">
								<img src="<?php echo esc_url( WCPSCWC_URL ); ?>assets/images/popup-icon/14-days-money-back-guarantee.png" alt="14-days-money-back-guarantee" title="14-days-money-back-guarantee" />
			...
			<div class="wcpscwc-sf-testimonial-wrap">
				...
				<div class="wcpscwc-testimonial-section-inr">
					...
					<a href="https://wordpress.org/support/plugin/woo-product-slider-and-carousel-with-category/reviews/?filter=5" target="_blank" class="wcpscwc-sf-btn"><span class="dashicons dashicons-star-filled"></span> View All Reviews</a> OR <a href="<?php echo WCPSCWC_PLUGIN_BUNDLE_LINK; ?>"  target="_blank" class="wcpscwc-sf-btn wcpscwc-sf-btn-orange"><span class="dashicons dashicons-cart"></span> Grab Now With Essential Bundle</a>
					<div class="wcpscwc-rc-wrap">
						<div class="wcpscwc-rc-inr wcpscwc-rc-bg-box">
							<div class="wcpscwc-rc-icon">
								<img src="<?php echo esc_url( WCPSCWC_URL ); ?>assets/images/popup-icon/14-days-money-back-guarantee.png" alt="14-days-money-back-guarantee" title="14-days-money-back-guarantee" />
