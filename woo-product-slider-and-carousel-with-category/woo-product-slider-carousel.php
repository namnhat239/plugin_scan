...
if( ! defined( 'WCPSCWC_VERSION' ) ) {
	define( 'WCPSCWC_VERSION', '2.6.8' ); // Version of plugin
}
...
if( ! defined( 'WCPSCWC_PLUGIN_LINK_UPGRADE' ) ) {
	define('WCPSCWC_PLUGIN_LINK_UPGRADE','https://www.essentialplugin.com/wordpress-plugin/woo-product-slider-carousel-category/?utm_source=WP&utm_medium=Product-Slider&utm_campaign=Upgrade-PRO#wpos-epb'); // Plugin Check link
}
