...
<br><br><br>
    <div onmousedown="return false;" onselectstart="return false;" style="max-height:130px;background-color:#a46497;color:white;border:1px solid #a46497;border-radius:13px;max-width:98%;">
...
<button style="padding:10px;background-color:#a46497;color:white;border:1px solid white;border-radius:13px;width:150px;" type="button" onclick="myFunctionpropurchbyuser()" onmouseout="outFuncpropurchbyuser()">
  <span class="tooltiptext" id="myTooltippropurchbyuser"><?php esc_html_e( 'Copy to Clipboard', 'woo-shortcodes-kit' ); ?></span>
...
function myFunctionpropurchbyuser() {
  ...
  tooltippropurchbyuser.innerHTML = "<?php esc_html_e( 'Copied:', 'woo-shortcodes-kit' ); ?> " + copyText.value;
}

function outFuncpropurchbyuser() {
  var tooltippropurchbyuser = document.getElementById("myTooltippropurchbyuser");
  tooltippropurchbyuser.innerHTML = "<?php esc_html_e( 'Copy to Clipboard', 'woo-shortcodes-kit' ); ?>";
}
...
<br><br>
        <p style="padding-left:30px;"><?php esc_html_e( 'You can use the shortcode where you want only need  to add the product ID', 'woo-shortcodes-kit' ); ?><strong> [woo_product_purchases id="<?php esc_html_e( 'Here write the product ID number', 'woo-shortcodes-kit' ); ?>"]</strong></p>
