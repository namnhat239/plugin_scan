...
$time           = get_the_date($attr['metaDateFormat']);
$timeModified   = get_the_modified_date($attr['metaDateFormat']);
...
$reading_time   = ceil(mb_strlen(strip_tags(get_the_content()))/1200).( isset($attr['metaMinText']) ? ' '.$attr['metaMinText'] : '' );