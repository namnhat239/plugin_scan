    ...
    class WWP_Script_Loader
    {
        ...
        public function load_back_end_styles_and_scripts($handle)
        {
            ...
            if (in_array($screen->id, array('edit-product'))) {
                ...
                wp_localize_script('wwp_percentage_wholesale_pricing_on_product_level_js', 'wwp_percentage_wholesale_options', array(
                    'wholesale_roles'                              => $this->_wwp_wholesale_roles->getAllRegisteredWholesaleRoles(),
             ...
             **********************************************************************************************************/
            // Load script if ACFW is not present
        ...
        private function role_page_upsell_message()
        {
            ...
            <div class="upsell-area">
                ...
                <p><?php echo sprintf(__('In the <a href="%1$s" target="_blank">Premium add-on</a> you can add multiple wholesale roles. This will let you create separate "levels" of wholesale customers,
                                                        each of which can have separate wholesale pricing, shipping and payment mapping, order minimums and more.', 'woocommerce-wholesale-prices'), 'https://wholesalesuiteplugin.com/woocommerce-wholesale-prices-premium/?utm_source=wwp&utm_medium=upsell&utm_campaign=wwprolespagelinkpopup'); ?>
                </p>
                <p>
                    <a class="button"
        ...
        public function wwp_store_management_link_script(){
            ...
            wp_enqueue_script('wwp-store-management-quick-link-js', WWP_JS_URL . 'app/wc-store-management-quick-links/build/static/js/wwp-store-management-quick-links.js', ['wp-hooks']);

            wp_localize_script('wwp-store-management-quick-link-js', 'options', array(
        ...
        public function wchome_wws_upgrade_to_premium(){
            if(isset($_GET['page']) && $_GET['page'] == 'wchome-wws-upgrade'){
                wp_redirect('https://wholesalesuiteplugin.com/bundle/?utm_source=wwp&utm_medium=upsell&utm_campaign=wchomeupgradelink');
                exit;
            }
        }
