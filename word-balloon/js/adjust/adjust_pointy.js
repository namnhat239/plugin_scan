...
function word_balloon_balloon_change_pointy(data) {
...
function word_balloon_change_balloon_space_pointy(box) {
	...
	box["padding_top"] = parseInt( document.getElementById('w_b_avatar_custom_size_'+box["size"]).value / 2.0 - on_balloon_margin);
