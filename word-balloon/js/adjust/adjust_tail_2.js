...
function word_balloon_balloon_change_tail_2(data) {

	var w_b_ava_box = document.getElementById('w_b_ava_box');

	w_b_ava_box.classList.add( 'w_b_mta' );
	w_b_ava_box.classList.add( 'w_b_jc_fe' );
	//w_b_ava_box.classList.add( 'w_b_mta' , 'w_b_jc_fe' );
...
function word_balloon_change_balloon_space_tail_2(box) {
