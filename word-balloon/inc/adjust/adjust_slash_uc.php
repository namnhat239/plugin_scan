...
function word_balloon_adjust_balloon_slash_uc($atts , $load_setting , $balloon_data){
...
/*
	if($atts['name_position'] === 'on_balloon') {
		if($atts['position'] === 'L'){
			$balloon_data['name_style'] .= 'margin-left:auto;';
		}else{
			$balloon_data['name_style'] .= 'margin-right:auto;';
		}
	}
	*/
/*
	else if($atts['name_position'] === 'under_balloon'){
		if($atts['position'] === 'L'){
			$balloon_data['name_style'] .= 'margin-left:auto;';
		}else{
			$balloon_data['name_style'] .= 'margin-right:auto;';
