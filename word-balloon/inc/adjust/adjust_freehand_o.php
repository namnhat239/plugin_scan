...
function word_balloon_adjust_balloon_freehand_o($atts , $load_setting , $balloon_data){
...
/*
	if($atts['name_position'] === 'on_balloon') {
		if($atts['position'] === 'L'){
			$balloon_data['name_style'] .= 'margin-right:12px;';
		}else{
			$balloon_data['name_style'] .= 'margin-left:12px;';
		}
	}
*/
	if($atts['name_position'] === 'under_balloon'){
		if($atts['position'] === 'L'){
			$balloon_data['name_style'] .= 'margin-top:-16px';
		}else{
			$balloon_data['name_style'] .= 'margin-top:-16px';
		}
	}
