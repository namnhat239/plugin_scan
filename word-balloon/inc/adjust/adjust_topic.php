...
function word_balloon_adjust_balloon_topic($atts , $load_setting , $balloon_data){
	...
	if($atts['border_color']){
		$balloon_data['border_style'] = 'border-top-color:' . $atts['border_color'] . ';';
	}
	$on_balloon_margin = 0;
...
function word_balloon_adjust_avatar_topic($atts , $load_setting , $avatar_data){
