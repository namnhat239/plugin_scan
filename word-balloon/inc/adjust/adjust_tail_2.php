...
function word_balloon_adjust_balloon_tail_2($atts , $load_setting , $balloon_data){

	if($atts['font_color']){
		$balloon_data['text_color'] = 'color:' .$atts['font_color']. ';';
	}
	if($atts['bg_color']){
		$balloon_data['background_color'] = '--w_b_tail_2:' . $atts['bg_color'] . ';';
	}
...
function word_balloon_adjust_avatar_tail_2($atts , $load_setting , $avatar_data){
