...
if ( 'edit.php' === $pagenow && 'size-chart-setting-page' === $get_page ) {
        ...
        foreach ( $all_roles as $role => $details ) {
            ...
            if ( 'administrator' !== $role ) {
                ...
                if ( array_key_exists( 'manage_woocommerce', $pw ) && array_key_exists( 'edit_posts', $pw ) ) {
                    ...
                    ?> value="<?php 
                    echo  esc_html_e( $role, 'size-chart-for-woocommerce' ) ;
                    ?>"><?php 
                    echo  esc_html_e( $details['name'], 'size-chart-for-woocommerce' ) ;
                    ?></option>
                                                        <?php 
                }
    ...
    echo  esc_attr( scfw_size_chart_get_tab_label() ) ;
    ?>"/>
                                </td>
                                <td>
    ...
    echo  esc_attr( scfw_size_chart_get_popup_label() ) ;
    ?>"/>
                                </td>
                            </tr>
                            <tr>
    ...
    echo  esc_attr( scfw_size_chart_get_sub_title_text() ) ;
    ?>"/>
                                </td>
                            </tr>
                        </table>
