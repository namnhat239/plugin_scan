...
.woo-orders-tracking-shortcode-timeline-icon-transit ',
	...
	public function shortcode_form_track_order() {
		ob_start();
		?>
        <form action="<?php echo esc_attr( esc_url( get_the_permalink( $this->settings->get_params( 'service_tracking_page' ) ) ) ) ?>"
              method="get"
            ...
            <div class="vi-woocommerce-orders-tracking-form-row">
                <input type="search"
                       ...
                       name="tracking_id"
                       autocomplete="off"
                       value="<?php echo esc_attr( isset( $_REQUEST['tracking_id'] ) ? sanitize_text_field( $_REQUEST['tracking_id'] ) : '' ) ?>">
                <input type="submit" name="submit_tracking"
                       class="vi-woocommerce-orders-tracking-form-search-tracking-number-btnclick"
                       value="<?php echo esc_attr( 'Track', 'woo-orders-tracking' ) ?>">
            </div>
        </form>
		<?php
