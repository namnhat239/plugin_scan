                ...
                <form action="" class="vi-ui form" method="post">
                    ...
                    <p>
                        ...
                        <button type="submit"
                                ...
                                class="<?php echo esc_attr( self::set( 'settings-save-button' ) ) ?> vi-ui button primary">
            ...
            <div class="<?php echo esc_attr( self::set( array( 'setting-shipping-carriers-filter-wrap' ) ) ) ?>">
                ...
                <div class="<?php echo esc_attr( self::set( array( 'setting-shipping-carriers-filter-country-wrap' ) ) ) ?>">
                    ...
                    <select name=""
                            ...
                            class="select2-hidden-accessible <?php echo esc_attr( self::set( array( 'setting-shipping-carriers-filter-country' ) ) ) ?>"
                        ...
                        <label for="amount"
                            ...
                            <select name="<?php echo esc_attr( self::set( 'settings' ) ) ?>[email][email_time_send_type]"
								...
								foreach ( $delay_time_type as $key => $value ) {
									...
									?>
                                    <option value="<?php echo esc_attr( $key ) ?>" <?php echo $selected ?>><?php echo esc_html__( $value ) ?></option>
									<?php
								}
								?>
                            </select>
                    ...
                    <select name="<?php echo esc_attr( self::set( 'settings' ) ) ?>[service_carrier][service_carrier_type]"
						...
						foreach ( $this->service_carriers_list as $item_slug => $item_name ) {
							if ( $item_slug === 'trackingmore' ) {
								?>
                                <option value="<?php echo esc_attr( $item_slug ) ?>"
			...
			foreach ( $imported as $item ) {
                ...
                <tr>
                    ...
                    <td style="border: 1px solid #e5e5e5;vertical-align: middle;padding: 12px;text-align: left; ">
                        ...
                        <a href="<?php echo esc_url( $item['tracking_url'] ) ?>" target="_blank"
