...
class VI_WOO_ORDERS_TRACKING_ADMIN_IMPORT_CSV {
	...
	public function generate_log_ajax() {
		...
		$file = wp_unslash( wc_clean( urldecode( $_GET['vi_wot_file'] ) ) );
		if ( ! is_file( $file ) ) {
	...
	public function import_csv() {
		...
		if ( $pagenow === 'admin.php' && $page === 'woo-orders-tracking-import-csv' ) {
			...
			$this->file_url = isset( $_REQUEST['file_url'] ) ? urldecode( wc_clean( wp_unslash( $_REQUEST['file_url'] ) ) ) : '';
                    ...
                    <div class="vi-ui negative message">
                        <div class="header">
							...
							switch ( $_REQUEST['vi_wot_error'] ) {
								...
								case 2:
									if ( $file_url ) {
										wp_kses_post( __( "Can not open file: <strong>{$file_url}</strong>", 'woo-orders-tracking' ) );
									} else {
								...
								default:
									if ( $file_url ) {
										wp_kses_post( __( "File not exists: <strong>{$file_url}</strong>", 'woo-orders-tracking' ) );
									} else {
                        ...
                        <form class="<?php echo esc_attr( self::set( 'import-container-form' ) ) ?> vi-ui form"
                            ...
                            <div class="vi-ui segment">
                                <table class="form-table">
                                    ...
                                    <tr>
                                        <th>
                                            <label for="<?php echo esc_attr( self::set( 'custom_start' ) ) ?>"><?php esc_html_e( 'Start line', 'woo-orders-tracking' ); ?></label>
                                        </th>
                                        <td>
                                            <input type="number"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <p class="description"><?php esc_html_e( 'Send email to customers when their orders\' tracking numbers are updated', 'woo-orders-tracking' ) ?>
                                                <a target="_blank"
                                                   href="<?php echo esc_attr( admin_url( 'admin.php?page=woo-orders-tracking#email' ) ) ?>"><?php esc_html_e( 'View settings', 'woo-orders-tracking' ) ?></a>
                                            </p>
                                        </td>
                                    </tr>
									<?php
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <p class="description"><?php esc_html_e( 'You have to enable at least 1 PayPal payment gateway and enter PayPal API to use this option.', 'woo-orders-tracking' ) ?>
                                                    <a target="_blank"
                                                       href="<?php echo esc_attr( admin_url( 'admin.php?page=woo-orders-tracking#paypal' ) ) ?>"><?php esc_html_e( 'View settings', 'woo-orders-tracking' ) ?></a>
                                                </p>
                                            </td>
                                        </tr>
                                            ...
                                            <select name="<?php echo esc_attr( self::set( 'order_status', true ) ) ?>"
												...
												if ( count( $all_order_statuses ) ) {
													foreach ( $all_order_statuses as $status_id => $status_name ) {
														?>
                                                        <option value="<?php echo esc_attr( $status_id ) ?>" <?php selected( $this->settings->get_params( 'order_status' ), $status_id ) ?> ><?php echo $status_name ?></option>
														<?php
													}
												}
												?>
									...
									foreach ( $headers as $header_k => $header_v ) {
                                        ...
                                        <tr>
                                            <td>
                                                <select id="<?php echo esc_attr( self::set( $header_k ) ) ?>"
													...
													foreach ( $this->header as $file_header ) {
														...
														?>
                                                        <option value="<?php echo urlencode( $file_header ) ?>"<?php echo esc_attr( $selected ) ?>><?php echo $file_header ?></option>
														<?php
													}
													?>
                                                </select>
                                            ...
                                            <td>
												...
												?>
                                                <label for="<?php echo esc_attr( self::set( $header_k ) ) ?>"><?php echo $label; ?></label>
                                            </td>
                                        </tr>
										<?php
					...
					case 'import':
                        ...
                        <div>
                            ...
                            <div style="display: none;"
                                 class="vi-ui indicating progress standard <?php echo esc_attr( self::set( 'paypal-progress' ) ) ?>">
                            ...
                            <div style="display: none;"
                                 class="vi-ui indicating progress standard <?php echo esc_attr( self::set( 'ppec_paypal-progress' ) ) ?>">
                            ...
                            <div style="display: none"
                                 class="vi-ui indicating progress standard <?php echo esc_attr( self::set( 'send-email-progress' ) ) ?>">
					...
					default:
                        ...
                        <form class="<?php echo esc_attr( self::set( 'import-container-form' ) ) ?> vi-ui form"
                            ...
                            <div class="vi-ui positive message <?php echo esc_attr( self::set( 'import-container' ) ) ?>">
                                <div class="header">
                                    <label for="<?php echo esc_attr( self::set( 'import-file' ) ) ?>"><?php _e( 'Select csv file to import', 'woo-orders-tracking' ); ?></label>
                                </div>
                                <ul class="list">
			...
			if ( count( $imported ) ) {
				foreach ( $imported as $item ) {
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid #e5e5e5;vertical-align: middle;padding: 12px;text-align: left; "><a
                                    href="<?php echo esc_url( $item['tracking_url'] ) ?>"
                        ...
                        <td style="border: 1px solid #e5e5e5;vertical-align: middle;padding: 12px;text-align: left; "><a
                                    href="<?php echo esc_url( $item['tracking_url'] ) ?>" target="_blank"
				...
				foreach ( $line_items as $item_id => $line_item ) {
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid #e5e5e5;vertical-align: middle;padding: 12px;text-align: left; "><a
                                    href="<?php echo esc_url( $carrier_url ) ?>"
                        ...
                        <td style="border: 1px solid #e5e5e5;vertical-align: middle;padding: 12px;text-align: left; "><a
                                    href="<?php echo esc_url( $carrier_url ) ?>" target="_blank"
                                    style="text-decoration: none;"><?php esc_html_e( 'Track', 'woo-orders-tracking' ); ?></a>
                        </td>
                    </tr>
					<?php
