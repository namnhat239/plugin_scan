        ...
        <div class="wrap">
            ...
            <form action="" method="post" id="vi_wot_export" class="vi-ui form">
                    ...
                    <div class="content active">
                        <table class="form-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="<?php echo esc_attr( self::set( 'export-filter-order-date-row' ) ) ?>"
                                        ...
                                        <div style="width: 30%">
                                            ...
                                            <p class="description <?php echo esc_attr( self::set( 'export-filter-order-date-range-from-error' ) ) ?>"
                                               style="color: red;"></p>
                                        ...
                                        <div style="width: 30%">
                                            ...
                                            <p class="description <?php echo esc_attr( self::set( 'export-filter-order-date-range-to-error' ) ) ?>"
                                               style="color: red;"></p>
                                    ...
                                    <select name="<?php echo esc_attr( self::set( 'export' ) ) ?>[filter-order-status][]"
										...
										if ( ! empty( $all_order_statuses ) ) {
											...
											foreach ( $all_order_statuses as $status_id => $status_name ) {
												...
												?>
                                                <option value="<?php echo esc_attr( $status_id ) ?>" <?php echo esc_attr( $selected ); ?> ><?php echo esc_html( $status_name ) ?></option>
												<?php
											}
										}
										?>
                                        ...
                                        <select name="<?php echo esc_attr( self::set( 'export-filter-order-billing-country' ) ) ?>"
											...
											if ( isset( $billing_country ) && is_array( $billing_country ) && count( $billing_country ) ) {
												foreach ( $billing_country as $country_id => $country_name ) {
													?>
                                                    <option value="<?php echo esc_attr( $country_id ) ?>"><?php esc_attr_e( $country_name ) ?></option>
													<?php
												}
											}
											?>
                                        ...
                                        <select name="<?php echo esc_attr( self::set( 'export-filter-order-billing-city' ) ) ?>"
											...
											if ( isset( $billing_city ) && is_array( $billing_city ) && count( $billing_city ) ) {
												foreach ( $billing_city as $city ) {
													?>
                                                    <option value="<?php echo esc_attr( $city ) ?>"><?php esc_attr_e( $city ) ?></option>
													<?php
												}
											}
											?>
                ...
                <p>
                    ...
                    <button type="submit"
                            class="button vi-ui  <?php echo esc_attr( self::set( 'export-order-button-save-settings' ) ) ?>"
                            name="<?php echo esc_attr( self::set( 'export-order-button-save-settings' ) ) ?>">
