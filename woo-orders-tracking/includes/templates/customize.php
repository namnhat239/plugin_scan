...
?>
<div class="<?php echo esc_attr( $settings->set( array( 'preview-shortcode-template-one' ) ) ) ?>">
    <div class="<?php echo esc_attr( $settings->set( array(
        ...
        <h2 class="<?php echo esc_attr( $settings->set( 'shortcode-timeline-title' ) ) ?>">
			<?php echo $title ?>
        </h2>
        <div class="<?php echo esc_attr( $settings->set( array(
        ...
        <div class="<?php echo esc_attr( $settings->set( 'shortcode-timeline-events-wrap' ) ); ?>">
			<?php
			$track_info = $shorcode['tracking'];
			for ( $i = 0; $i < count( $track_info ); $i ++ ) {
				?>
                <div class="<?php echo esc_attr( $settings->set( 'shortcode-timeline-event' ) ) ?>">
                    <div class="<?php echo esc_attr( $settings->set( array(
                    ...
                    <div class="<?php echo esc_attr( $settings->set( 'shortcode-timeline-event-content-wrap' ) ) ?>">
                        <div class="<?php echo esc_attr( $settings->set( 'shortcode-timeline-event-content' ) ) ?>">
                            <h4 class="<?php echo esc_attr( $settings->set( 'shortcode-timeline-event-des' ) ) ?>">
								<?php echo $i + 1 . '. ' . $track_info[ $i ]['description'] ?>
                            </h4>
                            <p>
                                <span class="<?php echo esc_attr( $settings->set( 'shortcode-timeline-event-location' ) ) ?>">
                                    <?php echo $track_info[ $i ]['location'] ?>
                                </span>
                                <span class="<?php echo esc_attr( $settings->set( 'shortcode-timeline-event-time' ) ) ?>">
                                    <?php
...
<div class="<?php echo esc_attr( $settings->set( array( 'preview-shortcode-template-two' ) ) ) ?>">
    <div class="<?php echo esc_attr( $settings->set( array(
			...
			for ( $i = 0; $i < $track_info_count; $i ++ ) {
                ...
                <div class="<?php echo esc_attr( $settings->set( 'shortcode-timeline-event' ) ) ?>">
                    ...
                    <div class="<?php echo esc_attr( $settings->set( 'shortcode-timeline-event-content-wrap' ) ) ?>">
                        ...
                        <div class="<?php echo esc_attr( $settings->set( 'shortcode-timeline-event-content-date' ) ) ?>">
							<?php
							echo date_format( date_create( $track_info[ $i ]['time'] ), $date_format . ' ' . $time_format );
							?>
                        </div>

                        <div class="<?php echo esc_attr( $settings->set( 'shortcode-timeline-event-content-des-wrap' ) ) ?>">
                            <div class="<?php echo esc_attr( $settings->set( 'shortcode-timeline-event-content-des' ) ) ?>">
								<?php echo $track_info[ $i ]['description'] ?>

                            </div>
                            <div class="<?php echo esc_attr( $settings->set( 'shortcode-timeline-event-location' ) ) ?>">
