...
if($threads){
  foreach ($threads as $thread) {
    ...
    $ticket_notes_history .= '<hr><strong>'.$user_name.'</strong> <small><i>'.$wpscfunction->time_elapsed_timestamp($thread->post_date_gmt).'</i>' . $thread_type. '</small><br>'.$thread->post_content;
