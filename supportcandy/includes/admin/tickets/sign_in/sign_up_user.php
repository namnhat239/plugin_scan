	...
	<div class="col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
		  ...
		  <form id="wpsc_frm_signup_user" method="post">
						<div class="form-group reg_required">
						 <label for="wpsc_register_user_first_name" style="color:<?php echo esc_attr($general_appearance['wpsc_text_color'])?> !important;"><?php _e('First Name','supportcandy');?></label>
						...
						<div class="form-group reg_required">
							<label for="wpsc_register_user_last_name" style="color:<?php echo esc_attr($general_appearance['wpsc_text_color'])?> !important;"><?php _e('Last Name','supportcandy');?></label>
							<span class="wpsc_reg_required_sym">*</span>
				   ...
				   <div class="form-group reg_required">
					 <label for="wpsc_register_user_name" style="color:<?php echo esc_attr($general_appearance['wpsc_text_color'])?> !important;"><?php _e('Username','supportcandy');?></label>
					 <span class="wpsc_reg_required_sym">*</span>
		       ...
		       <div class="form-group reg_required">
				 <label for="wpsc_register_email" style="color:<?php echo esc_attr($general_appearance['wpsc_text_color'])?> !important;"><?php _e('Email','supportcandy');?></label>
				 <span class="wpsc_reg_required_sym">*</span>
			     ...
			     <div class="form-group reg_required">
					 <label for="wpsc_register_pass" style="color:<?php echo esc_attr($general_appearance['wpsc_text_color'])?> !important;"><?php _e('Password','supportcandy');?></label>
					 <span class="wpsc_reg_required_sym">*</span>
			         <input type="password" id="wpsc_register_pass" class="form-control" name="wpsc_register_pass" />      
			     </div>

			     <div class="form-group reg_required">
					 <label for="wpsc_register_confirmpass" style="color:<?php echo esc_attr($general_appearance['wpsc_text_color'])?> !important;" ><?php _e('Confirm Password','supportcandy');?></label>
					 <span class="wpsc_reg_required_sym">*</span>
					...
					<?php
						if($wpsc_registration_captcha && $wpsc_recaptcha_type){
							?>
							<div class="col-md-12 captcha_container" style="margin-bottom:10px;margin-left:0px; display:flex; background-color:<?php echo esc_attr($wpsc_appearance_create_ticket['wpsc_captcha_bg_color'])?> !important;color:<?php echo esc_attr($wpsc_appearance_create_ticket['wpsc_captcha_text_color'])?> !important;">
			...
			?>
			     ...
			     <div class="form-group">
			         <button type="submit" class="btn btn-sm" name='btnsubmit' onclick="javascript:wpsc_register_user(event);" style="background-color:<?php echo esc_attr($wpsc_appearance_signup['wpsc_appearance_signup_button_bg_color'])?> !important; color:<?php echo esc_attr($wpsc_appearance_signup['wpsc_appearance_signup_button_text_color'])?> !important; border-color:<?php echo esc_attr($wpsc_appearance_signup['wpsc_appearance_signup_button_border_color'])?> !important;"><?php _e('Register Now','supportcandy')?></button>
						   <button type="cancel" class="btn btn-sm" name='btncancel' onclick="javascript:wpsc_sign_in();" style="background-color:<?php echo esc_attr($wpsc_appearance_signup['wpsc_appearance_cancel_button_bg_color'])?> !important;color:<?php echo esc_attr($wpsc_appearance_signup['wpsc_appearance_cancel_button_text_color'])?> !important; border-color:<?php echo esc_attr($wpsc_appearance_signup['wpsc_appearance_cancel_button_border_color'])?> !important;"><?php _e('Cancel','supportcandy');?></button>
	         </div>
					 ...
					 <input type="hidden" name="_ajax_nonce" value="<?php echo wp_create_nonce('submit_user')?>">
