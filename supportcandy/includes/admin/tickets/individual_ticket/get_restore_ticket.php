...
<form id="frm_restore_ticket">
    ...
    <input type="hidden" name="_ajax_nonce" value="<?php echo wp_create_nonce('set_restore_ticket')?>">
</form>
...
<button type="button" class="btn wpsc_popup_action" onclick="wpsc_set_restore_ticket(<?php echo esc_attr($ticket_id)?>);"><?php _e('Confirm','supportcandy');?></button>
<?php
