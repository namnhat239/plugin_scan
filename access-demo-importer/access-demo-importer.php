...
if ( !class_exists( 'Access_Demo_Importer' ) ) {
    ...
    class Access_Demo_Importer {
        ...
        public static function scripts( $hook_suffix ) {
            ...
            if ( ('appearance_page_demo-importer' == $hook_suffix) || ('appearance_page_welcome-page' == $hook_suffix) || ($template_slug == $hook_suffix) ) {
                ...
                wp_localize_script( 'adi-demos-js', 'accessLoc', array(
					...
					'adi_install_pro_plugin_nonce'  => wp_create_nonce( 'adi_install_pro_plugin_nonce' ),
                    'adi_activate_req_plugin_nonce' => wp_create_nonce( 'adi_activate_req_plugin_nonce' ),
                    'adi_demo_data_reset_nonce'     => wp_create_nonce( 'adi_demo_data_reset_nonce' ),
                            ...
                            <div class="demo">
                                ...
                                <div class="demo-btn-wrapp">
                                    ...
                                    <div class="buttons-wrapp">
                                        <a href="#" class="button install-btn install-demo-btn-step adi-open-popup" data-demo-id="<?php echo esc_attr($key); ?>"><?php esc_html_e($install_text); ?></a>
        ...
        function adi_demo_data_reset() {
            check_ajax_referer( 'adi_demo_data_reset_nonce', 'security' );
