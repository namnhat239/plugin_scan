...
/*
  ...
  Copyright 2015 - 2021  WebFactory Ltd  (email: wp301@webfactoryltd.com)
        ...
        <div class="row">
              ...
              <div class="tab-pane fade show active" id="redirect-rules" role="tabpanel" aria-labelledby="home-tab">
                ...
                <form action="" method="post">
                  ...
                  <table class="table table-striped table-bordered">
                    ...
                    ?>
                        <tr class="redirect-row" id="customRow<?php echo $custom_id; ?>">
                          ...
                          <td>
                            <a title="Go PRO to access stats" class="open-301-pro-dialog pro-feature" data-pro-feature="redirect-rules-chart-icon-<?php echo $i; ?>" href="#"><span class="dashicons dashicons-chart-area"></span></a>
          ...
          <div class="d-md-none d-sm-none d-xs-none col-3 d-lg-block d-xl-block">
            <div class="sidebar-box pro-ad-box">
              <p class="text-center"><a href="https://wp301redirects.com/?ref=301-free-sidebar-box" target="_blank"><img src="<?php echo self::$plugin_url . 'img/wp-301-logo-full.png'; ?>" alt="WP 301 Redirects PRO" title="WP 301 Redirects PRO"></a><br>PRO version is here! Grab the launch discount.<br><b>All prices are LIFETIME!</b></p>
...
<?php
  ...
  static function tab_404()
  {
    ...
    if (!sizeof($log)) {
      ...
      foreach ($log as $l) {
        ...
        echo '<td nowrap>' . $l['user_agent'] . '</td>';
  ...
  static function widget_content()
  {
    ...
    if (!sizeof($log)) {
      ...
      echo '<p>View the entire <a href="' . admin_url('options-general.php?page=301-redirects#error-log') . '">404 error log</a> in the 301 Redirects plugin or <a href="' . admin_url('options-general.php?page=301-redirects#redirect-rules') . '">create new redirect rules</a> to fix 404 errors.</p>';
    }
  } // widget_content
  ...
  static function pro_dialog()
  {
    ...
    $out .= '<div class="center logo"><a href="https://wp301redirects.com/?ref=301-free-pricing-table" target="_blank"><img src="' . self::$plugin_url . 'img/wp-301-logo-full.png' . '" alt="WP 301 Redirects PRO" title="WP 301 Redirects PRO"></a><br>';
