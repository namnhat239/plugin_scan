<div class="row row-tab" id="row-tab-options">
	...
	<div class="col-xs-12 sub-tab-content" id="sub-tab-options-main" data-no-preview="1">
		...
		<div class="row row-settings-block">
			...
			?>
				<i class="fa fa-question woobewoo-tooltip" title="<?php /*echo esc_attr(__('The filter will be located in a popup', 'woo-product-filter')); */
			?>"></i>
			</div>
			<div class="settings-block-values col-xs-8 col-lg-9">
				<span class="settings-value wpfProLabel"><a href="<?php /*echo esc_url($this->proLink . '?utm_source=floatingmode&utm_medium=optionsmain&utm_campaign=pluginfilter'); */
			?>" target="_blank"><?php /*esc_html_e('PRO Option', 'woo-product-filter'); */
			?></a></span>
			</div>
		</div>-->
