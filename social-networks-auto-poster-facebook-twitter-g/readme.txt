...
Free plugin is limited to one account per each type of connected networks. In other words you can add 1 VK, AND 1 Twitter AND 1 LinkedIn AND 1 etc ... accounts in the "Free" version. This is enough for about 95% of users.

<a href="https://www.nextscripts.com/social-networks-autoposter-wordpress-plugin-pro/">SNAP Pro Plugin</a> is NOT limited in number of accounts per each type of connected networks.  You can add 10 (or 100) VK, AND 15 Twitter AND 5 LinkedIn AND 25 etc ... accounts in the "Pro" version. 
