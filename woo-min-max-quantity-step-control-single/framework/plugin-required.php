...
if( ! class_exists( 'Plugin_Required' ) ){
    ...
    class Plugin_Required
    {
        ...
        public static function display_notice()
        {
                ...
                $small_notc = new Notice('small-122');
                $small_notc->set_message(sprintf( __( '<b>Woocommerce Min Max Step Control</b>: lots of special feature waiting for you. %s.', 'wpt_pro' ), "<a href='https://codeastrology.com/min-max-quantity/pricing/'>Get Premium</a>" ));
