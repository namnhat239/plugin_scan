    ...
    <div class="afrsm-section-left">
        <div class="advance_zone_listing">
            <div class="right_button_add_zone">
				...
				?>
                <a href="<?php echo esc_url( add_query_arg( array( 'page' => 'afrsm-wc-shipping-zones&add_zone' ), admin_url( 'admin.php' ) ) ); ?>"
                   class="button-primary">
					<?php esc_html_e( 'Add Shipping Zone', 'advanced-flat-rate-shipping-for-woocommerce' ); ?>
                </a>
            </div>
