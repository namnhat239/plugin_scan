        ...
        <div class="afrsm-main-table res-cl">
            ...
            <table class="table-outer">
                ...
                <tr>
                    ...
                    <td class="fr-2"><?php esc_html_e( AFRSM_PRO_PLUGIN_NAME, 'advanced-flat-rate-shipping-for-woocommerce' ); ?></td>
                </tr>
                <tr>
                    <td class="fr-1"><?php esc_html_e( 'Installed Version', 'advanced-flat-rate-shipping-for-woocommerce' ); ?></td>
                    <td class="fr-2"><?php esc_html_e( AFRSM_PRO_PREMIUM_VERSION, 'advanced-flat-rate-shipping-for-woocommerce' ); ?>&nbsp;<?php echo esc_html_e( AFRSM_PRO_PLUGIN_VERSION, 'advanced-flat-rate-shipping-for-woocommerce' ); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="fr-2">
                        <ul>
                            ...
                            <li><a target="_blank"
                                   href="<?php echo esc_url( 'https://docs.thedotstore.com/collection/81-flat-rate-shipping-plugin-for-woocommerce' ); ?>"><?php esc_html_e( 'Guide Documentation', 'advanced-flat-rate-shipping-for-woocommerce' ); ?></a>
                            </li>
                            <li><a target="_blank"
