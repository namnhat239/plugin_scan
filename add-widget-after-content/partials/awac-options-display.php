    ...
    <div id="ps_admin" class="metabox-holder has-right-sidebar">
        <div class="inner-sidebar">
               ...
               <div class="postbox">
                    <div class="inside">
                        <p><?php $url1 = 'https://pintopsolutions.com/contact/?utm_source=awacadmin&utm_medium=link&utm_content=contact&utm_campaign=plugin';
                            $link1     = sprintf( __( 'Need help? Or have an idea how this plugin can be made better. Reach out', 'add-widget-after-content' ). '<a href=%s> on our website?</a>', esc_url( $url1 ) );
                            echo $link1; ?></p>

                        <p><?php $url2 = 'https://wordpress.org/support/view/plugin-reviews/add-widget-after-content?filter=5#postform';
                            $link2 = sprintf( __( 'We invite you to', 'add-widget-after-content' ). '<a href=%s>'. __( ' leave an honest review', 'add-widget-after-content' ).'.</a>', esc_url( $url2 ) );
                            echo $link2; ?></p>
            ...
            if ( ! class_exists( 'awacPlus' ) ) {
                ...
                $link6 = sprintf('<a href=%s><img src="%s" alt=""></a>', esc_url( $url6 ), esc_url( $img6 ) );
                echo $link6;
            }
            ...
            if ( ! class_exists( 'awacWidgetControls' ) ) {
                ...
                $link5       = sprintf('<a href=%s><img src="%s" alt=""></a>', esc_url( $url5 ), esc_url( $img5 ) );
                echo $link5;
            }
            ...
            if ( ! class_exists( 'awacWidgetStyles' ) ) {
                ...
                $link4       = sprintf('<a href=%s><img src="%s" alt=""></a>', esc_url( $url4 ), esc_url( $img4 ) );
                echo $link4;
            }
