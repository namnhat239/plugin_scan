	...
	class AddWidgetAfterContentAdmin {
        ...
        public function awac_display_admin_footer($text) {
            ...
            if ( $currentScreen->id == 'appearance_page_awac-options' ) {
                $rate_text = sprintf( __( 'Thank you for using ',  'add-widget-after-content' ) . '<a href="%1$s" target="_blank">'. __( 'Add Widget After Content',  'add-widget-after-content' ) . '</a>! '.  __( 'Please ',  'add-widget-after-content' ) . '<a href="%2$s" target="_blank">'. __( 'rate us on ',  'add-widget-after-content' ) . '</a><a href="%2$s" target="_blank">WordPress.org</a>',
