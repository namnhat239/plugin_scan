 ...
 */
if ( ! function_exists( 'ualGformsSaveEntry' ) ) {

	function ualGformsSaveEntry( $action_type, $result ) {
...
add_action( 'check_admin_referer', 'ualGformsSaveEntry', 10, 2 );
...
if ( ! function_exists( 'ualGformsDuplicateNotify' ) ) {

	function ualGformsDuplicateNotify( $action, $result ) {
...
add_action( 'check_admin_referer', 'ualGformsDuplicateNotify', 10, 2 );
 ...
 */
if ( ! function_exists( 'ualGarvityFormUpdatedOption' ) ) {
	function ualGarvityFormUpdatedOption( $option, $oldvalue = null, $_newvalue = null ) {
...
add_action( 'updated_option', 'ualGarvityFormUpdatedOption', 20, 3 );
add_action( 'delete_option', 'ualGarvityFormUpdatedOption', 20, 3 );
add_action( 'add_option', 'ualGarvityFormUpdatedOption', 20, 3 );
 ...
 * @param string $status Previous Status
 * @param int $lead_id The current lead ID
 */
 ...
 * @param string $_newvalue
 */
if ( ! function_exists( 'ualGarvityFormLicenceUpdated' ) ) {
	function ualGarvityFormLicenceUpdated( $option, $oldvalue, $_newvalue ) {
...
add_action( 'updated_option', 'ualGarvityFormLicenceUpdated', 20, 3 );
