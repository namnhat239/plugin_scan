 ...
 */
add_action( 'updated_option', 'ualWpSEOUpdatedOption', 10, 3 );

if ( ! function_exists( 'ualWpSEOUpdatedOption' ) ) {
	function ualWpSEOUpdatedOption( $option, $old_value = null, $value = null ) {
