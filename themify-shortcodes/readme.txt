...
= 2.0.7 (2021.03.22) =
* Use Themify Twitter/Map API key settings if using a Themify theme

= 2.0.6 (2021.03.15) =
* Add shortcode generator to TinyMCE

= 2.0.5 (2021.01.13) =
* Fix: Missing preset icons in Box shortcode
* Added filter for Themify themes to hook options

= 2.0.4 (2020.11.13) =
* Fix: Icon not align perfectly in container

= 2.0.3 (2020.11.09) =
* Changed: Updated icon shortcode
