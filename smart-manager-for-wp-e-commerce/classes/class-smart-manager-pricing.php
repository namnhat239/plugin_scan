		...
		<div class="wrap about-wrap sm">
				...
				<?php if( defined('SA_OFFER_VISIBLE') && true === SA_OFFER_VISIBLE ){ ?>
					...
					<div class="sa_offer">
						<div class="sa_offer_content">
							<a href="https://www.storeapps.org/woocommerce-plugins/?utm_source=in_app_pricing&utm_medium=sm_banner&utm_campaign=sa_bfcm_2021" target="_blank">
								<img src="<?php echo esc_url( plugins_url( 'sa-includes/images/bfcm-2021.png', (dirname( SM_PLUGIN_FILE )) . '/classes/sa-includes/' ) ); ?>" />
							</a>
						</div>
					</div>
				<?php } else { ?>
				...
				<div id="sm_price_column_container">
					<div class="sm_column column_one_fourth pricing">
						...
						<span class="sm_price">
							...
							<h2><?php echo ( defined('SA_OFFER_VISIBLE') && true === SA_OFFER_VISIBLE ) ? __( '$75', 'smart-manager-for-wp-e-commerce' ) : __( '$112', 'smart-manager-for-wp-e-commerce' ); ?></h2>
						</span>

						<div class="center">
							<a class="sm_button small green center" href="https://www.storeapps.org/?buy-now=18694&qty=1<?php echo ( defined('SA_OFFER_VISIBLE') && true === SA_OFFER_VISIBLE ) ? '' : '&coupon=sm-25off'; ?>&page=722&with-cart=1&utm_source=sm&utm_medium=in_app_pricing&utm_campaign=single_annual" target="_blank" rel="noopener"><?php _e( 'Buy Now', 'smart-manager-for-wp-e-commerce' ); ?></a>
						</div>
					</div>
					<div class="sm_column column_one_fourth pricing scaleup" style="border-color: #15576F;padding: 0;border-width: 0.2em;">
						...
						<span class="sm_price">
							...
							<h2><?php echo ( defined('SA_OFFER_VISIBLE') && true === SA_OFFER_VISIBLE ) ? __( '$90', 'smart-manager-for-wp-e-commerce' ) : __( '$135', 'smart-manager-for-wp-e-commerce' ); ?></h2>
						</span>

						<div class="center">
							<a class="sm_button small green center" href="https://www.storeapps.org/?buy-now=18693&qty=1<?php echo ( defined('SA_OFFER_VISIBLE') && true === SA_OFFER_VISIBLE ) ? '' : '&coupon=sm-25off'; ?>&page=722&with-cart=1&utm_source=sm&utm_medium=in_app_pricing&utm_campaign=multi_annual" target="_blank" rel="noopener"><?php _e( 'Buy Now', 'smart-manager-for-wp-e-commerce' ); ?><span style="width: 1em; height: 1em; background-image: url('https://www.storeapps.org/wp-content/themes/storeapps/assets/images/fidget.svg'); display: inline-block; margin-left: 0.5em" class="fidget spin"></span></a>
						</div>
					</div>
					<div class="sm_column column_one_fourth pricing sm_lifetime_price">
						...
						<div class="center">
							<a class="sm_button small green center" href="https://www.storeapps.org/?buy-now=86835&qty=1&coupon=sm-25off-l&page=722&with-cart=1&utm_source=sm&utm_medium=in_app_pricing&utm_campaign=single_lifetime" target="_blank" rel="noopener"><?php _e( 'Buy Now', 'smart-manager-for-wp-e-commerce' ); ?></a>
						</div>
					</div>
					<div class="sm_column column_one_fourth pricing sm_last sm_lifetime_price">
						...
						<span class="sm_price">
							...
							<h2><?php echo __( '$375', 'smart-manager-for-wp-e-commerce' ); ?></h2>
						</span>
			...
			<div class="sm_row" id="sm-testimonial">
				<div class="sm_column sm-testimonial-content">
					...
					<div class="sm_testimonial_text">
						...
						- <?php echo __( 'Jeff', 'smart-manager-for-wp-e-commerce' ); ?>
					</div>
				</div>
			</div>
			...
			<div class="sm_row" id="sm-testimonial-others">
				<div style="width: 70%; margin: 0 auto; display: flex; gap: 2em;">
					<div class="sm_column sm-testimonial-content">
						<img src="<?php echo SM_IMG_URL ?>acrom.png" alt="Acrom" />
						<h3 class="sm_testimonial_headline"><?php echo __( 'A whole afternoon’s work in seconds', 'smart-manager-for-wp-e-commerce' ); ?></h3>
						<div class="sm_testimonial_text">
							<?php echo __( 'We recommend Smart Manager Pro to everyone who is looking for an extremely multi-functional store manager. The plugin is absolutely worth it. Never again without Smart Manager!', 'smart-manager-for-wp-e-commerce' ); ?><br>
							- <?php echo __( 'Acrom', 'smart-manager-for-wp-e-commerce' ); ?>
						</div>
					</div>
					<div class="sm_column sm-testimonial-content">
						<img src="<?php echo SM_IMG_URL ?>bryan-batcher.jpeg" alt="Bryan Batcher" />
						<h3 class="sm_testimonial_headline"><?php echo __( '20 or 30 times quicker store management', 'smart-manager-for-wp-e-commerce' ); ?></h3>
						<div class="sm_testimonial_text">
							<?php echo __( 'I\'ve got over 200 products and dreaded managing them one by one. Smart Manager Pro plugin lets me do this so much quicker. Probably 20 or 30 times quicker. It is an absolutely invaluable tool.', 'smart-manager-for-wp-e-commerce' ); ?><br>
							- <?php echo __( 'Brian Batcher', 'smart-manager-for-wp-e-commerce' ); ?>
						</div>
					</div>
				</div>
			</div>
			<div class="sm_row" id="sm_product_page_link">
				<?php echo sprintf( __( 'You can either spend hours of work in store management or use %s to accomplish the same within minutes.', 'smart-manager-for-wp-e-commerce' ), '<a style="color: #00848D;" target="_blank" href="https://www.storeapps.org/product/smart-manager/?utm_source=sm&utm_medium=in_app_pricing&utm_campaign=sm_know">' . __( 'Smart Manager Pro', 'smart-manager-for-wp-e-commerce' ) . '</a>' ); ?><br>
