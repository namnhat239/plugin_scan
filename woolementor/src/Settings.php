			...
			'sections'      => [
				...
				'woolementor_tools'	=> [
					...
					'fields'    => [
						...
						// 	'label'     => __( 'Enable Recently Viewed Products', 'woolementor' ),
						// 	'type'      => 'switch',
						// 	'desc'      => __( 'Enable recently viewed products on your shop.', 'woolementor' ),
						// 	'disabled'  => false,
						// ],
						// 'recently_sold_products' => [
						// 	'id'      	=> 'recently_sold_products',
						// 	'label'     => __( 'Enable Recently Sold Products', 'woolementor' ),
						// 	'type'      => 'switch',
						// 	'desc'      => __( 'Enable recently sold products on your shop.', 'woolementor' ),
						// 	'disabled'  => false,
						// ],
						'quantity_input' => [
							'id'      	=> 'quantity_input',
