...
If you are an event planner or event manager, and work for a small, medium or large organization that needs more sophisticated event management tools, **check out our [Event Calendar Software](https://time.ly/solutions/event-calendar-software/) and our [premium features] (https://time.ly/event-management-software-features/)**.

= 🌟 Features =

Our free events calendar plugin is feature-rich. Download the plugin and get all the following features for FREE:

* **Beautiful** event calendar for your website.
* Available in several languages, including **English**, **French**, **Spanish**, **Portuguese**, **Italian**, **German** and **Dutch**, and other languages upon request.
...
* Display your public calendar on **week, month or agenda views**. Additional calendar views available as add-on.
...
* **Search box** to search for events by date, month and year.
...
* **Easy importing and sharing** with Google Calendar, Apple iCal, MS Outlook and any other system that accepts iCalendar (.ics) feeds.
* **Automatically import events** from other calendars into your own calendar.
...
* [**Extended Views**](https://time.ly/solutions/all-in-one-event-calendar-wordpress-plugin/): make your wp calendar even more stunning with a new theme, as well as stream, tile and posterboard views.
...
If you are looking for more advanced features, like finding, importing and automatically syncing events from other calendars and the web, event submission form, and Facebook & Twitter integration, check our [feature list](https://time.ly/event-management-software-features) and consider upgrading to one of our [premium paid plans](https://time.ly/pricing/).
...
Timely's events calendar public interface has been translated into the same languages above, plus (in alphabetical order): Arabic | Danish | Japanese | Korean | Turkish. Other languages are available upon request.
...
* [Demo events calendar](https://events.timely.fun/cfolk0j0/agenda)
* Timely’s official [homepage](https://time.ly/).
* Timely’s [Help Center](https://help.time.ly/all-in-one-event-calendar-wp-plugin-guide-v3/).
* Timely’s [Reviews and Customer Testimonials](https://time.ly/why-timely/customer-testimonials/).
* Timely’s [Case Studies](https://time.ly/blog/category/case-study/).
* Timely’s [Press Mentions](https://time.ly/newsroom/).
* Timely’s [Event Management Blog](https://time.ly/blog/).
...
**Please note that we DO NOT provide live support to free users**. You can check the [All-in-One Event Calendar forum here on WordPress.org](https://wordpress.org/support/plugin/all-in-one-event-calendar/), which is the place where community members help one another.  If you need official support from us, consider upgrading to a [premium paid plan](https://time.ly/pricing/).

If you have Timely’s WP events calendar widget version 3.0.0 (old platform), 2.6.8 or older (deprecated / superseded), and need assistance, check the corresponding [User Guide](https://help.time.ly/event-calendar-wordpress-plugin/).
...
WordPress clients can access the plugin written documentation on our [Help Center](https://help.time.ly/all-in-one-event-calendar-wp-plugin-guide-v3/). If you have Timely’s WP plugin version 3.0.0 (old platform), 2.6.8 or older (deprecated / superseded), please read the corresponding [User Guide](https://help.time.ly/event-calendar-wordpress-plugin/).
...
If you need official and timely support from us, consider upgrading to a premium paid plan. As a paying client, you will have access to our training videos, and get live support via online chat and email. Please [contact us](https://time.ly/contact/) to learn more.
...
Yes! [Timely All-in-One Event Calendar](https://time.ly/solutions/all-in-one-event-calendar-wordpress-plugin/) has a built-in tool to import events with ease. In the menu **Import Events** in your Timely dashboard, you can either add a URL feed or upload a CSV or an ICS file to import events from Google Calendar, Apple iCal, MS Outlook and any other system that accepts iCalendar (.ics) feeds. You can even set it up for AUTOMATICALLY import events from other calendars and online sources. If you are an event aggregator, these tools will be perfect for you!

Our Event Finder feature allows you to find events from our network of events calendars, and import them into your calendar. This feature is available on premium paid plans only. Please [contact us](https://time.ly/contact/) to learn more.
...
* [**Extended Views**](https://time.ly/solutions/all-in-one-event-calendar-wordpress-plugin/): for adding a new theme, and three additional cool calendar views; and
...
Our Event Submission Form feature allows your website visitors to submit events to your calendar. As the calendar owner, you have full publishing control and can decide whether event submissions are approved automatically, or just after being approved by you. This feature is available on premium paid plans only. Please [contact us](https://time.ly/contact/) to learn more.
...
For small, medium and larger organizations that need more advanced tools, Timely offers a myriad of event management software solutions. Our premium solutions include [Event Calendar Software](https://time.ly/solutions/event-calendar-software/), [Event Booking Software](https://time.ly/solutions/event-booking-software/), [Event Ticketing Software](https://time.ly/solutions/event-ticketing-software/), [Online Training Software](https://time.ly/solutions/online-training-software/) and [Online School Agenda](https://time.ly/solutions/online-school-agenda/).
