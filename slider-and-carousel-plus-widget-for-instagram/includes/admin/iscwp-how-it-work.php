								...
								<div class="inside">
									<table class="form-table">
										<tbody>
											...
											<tr>
												<th>
													<label><?php _e('Need Support?', 'slider-and-carousel-plus-widget-for-instagram'); ?></label>
												</th>
												<td>
													...
													<a class="button button-primary" href="https://docs.wponlinesupport.com/slider-and-carousel-plus-widget-for-instagram/" target="_blank"><?php _e('Documentation', 'slider-and-carousel-plus-widget-for-instagram'); ?></a>
													<a class="button button-primary" href="https://demo.wponlinesupport.com/slider-and-carousel-plus-widget-for-instagram-demo/" target="_blank"><?php _e('Demo for Designs', 'slider-and-carousel-plus-widget-for-instagram'); ?></a>
												</td>
											</tr>
										</tbody>
									</table>
