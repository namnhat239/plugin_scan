...
function iscw_grid( $atts, $content = null ) {
	...
	<div class="iscwp-main-wrp iscwp-clearfix">
		<div id="iscwp-gallery-<?php echo $unique; ?>" class="iscwp-gallery-main-wrap iscwp-gallery-grid <?php echo $popup_cls.' '.$image_fit_class; ?> <?php echo $grid_cls; ?> iscwp-clearfix" data-user="<?php echo $username; ?>" <?php if( empty($insta_user_media) ){ ?> data-ajax="true" data-ajax-conf="<?php echo htmlspecialchars(json_encode($ajax_conf)); ?>" <?php } ?>>
