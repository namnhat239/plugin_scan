<div class="iscwp-left-panel">
	<?php if( !empty($iscwp_data['is_video']) ) { ?>
		<video id="iscwp-player-<?php echo $count; ?>" class="iscwp-video" controls preload="false" poster="<?php echo esc_url( $iscwp_data['display_url'] ); ?>">
			<source src="<?php echo esc_url( $video_url ); ?>" type="video/mp4"></source>
		</video>
	<?php } else { ?>
	...
	<div class="iscwp-user-head-box">
		...
		<div class="iscwp-user-head-box-inner">
			<a class="iscwp-user-img" href="<?php echo $instagram_link_main.$username; ?>" target="_blank">
				<img src="<?php echo esc_url( $userdata['profile_picture'] ); ?>" class="iscwp-img-user" alt="" />
			</a>
			...
			<a href="<?php echo esc_url( $instagram_link ); ?>" class="iscwp-view-on-insta-link" target="_blank">
