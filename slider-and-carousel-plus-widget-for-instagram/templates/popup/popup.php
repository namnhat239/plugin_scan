<div id="wp-iscwp-popup-<?php echo $unique.'-'.$count; ?>" class="wp-iscwp-popup-box iscwp-popup-design-1 wp-iscwp-popup-content mfp-hide" <?php echo $popup_attr; ?>>
	...
	<a href="javascript:void(0);" class="wp-iscwp-popup-close wp-iscwp-close-btn mfp-close" title="<?php esc_html_e('Close', 'slider-and-carousel-plus-widget-for-instagram'); ?>"></a>
