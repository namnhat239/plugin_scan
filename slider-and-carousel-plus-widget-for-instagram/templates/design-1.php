		...
		<div class="iscwp-inr-wrp-content">		
			<div class="iscwp-img-wrp" <?php echo $height_css; ?> >
				<?php if( $instagram_link ) { ?>
					<img class="iscwp-img" src="<?php echo esc_url( $gallery_img_src ); ?>" title="" alt="" />
					...
					<?php } ?>
					<a class="iscwp-img-link" data-mfp-src="<?php echo "#wp-iscwp-popup-{$unique}-{$count}"; ?>" href="<?php echo $iscwp_link_value; ?>" target="_blank" ></a>
				<?php } else { ?>
					<img class="iscwp-img" src="<?php echo esc_url( $gallery_img_src ); ?>" title="" alt="" />
				<?php } ?>
			</div>
