            ...
            foreach( $fields as $fypes => $field_meta ){
                if( $fypes == "billing" ){
                    ...
                    foreach( $billing_metas as $key => $val ){ 
                        ...
                        if (!empty($billing_meta["name"]) && !isset( $fields[$fypes][$billing_meta["name"]] ) && is_array( $billing_meta ) && !$billing_meta["is_unremovable"] ){
                    ...
                    foreach( $shipping_metas as $key => $val ){
                        ...
                        if(!empty($shipping_meta["name"]) && !isset( $fields[$fypes][$shipping_meta["name"]] )  && is_array( $shipping_meta ) && !$shipping_meta["is_unremovable"] ){
