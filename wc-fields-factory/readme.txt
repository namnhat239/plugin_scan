...
WC Fields Factory is a woocommerce product addon, which helps to add custom fields to your woocommerce product page, using which you can gather additional details from the customers while the order being placed.


== Description ==

WC Fields Factory is a woocommerce product addon, which helps to add custom fields to your woocommerce product page, using which you can gather additional details from the customers while the order being placed. (like, getting the Name that has to be printed on the TShirt that your are selling).

The additional information that has been captured on the product page would be carried over to Cart -> Checkout -> Order & Email.

Here is our Intro + Demo video : 
