			...
			<label>Font:</label>
                        <div class="field">
                            <select name="sfsi_popup_font" id="sfsi_popup_font" class="styled">
                                ...
                                <option value="Arial Black, Gadget, sans-serif" <?php echo ($option7['sfsi_popup_font']=='Arial Black, Arial Black, Gadget, sans-serif') ?  'selected="true"' : '' ;?>>Arial Black</option>
