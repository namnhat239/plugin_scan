...
<div class="tab5">
   ...
   <!-- END icon's size and spacing section -->
	...
	<div class="field " >
		...
		<option value="top-left" <?php echo ($option5['sfsi_icons_Alignment']=='top-left') ?  'selected="selected"' : '' ;?> >Top - Left</option>
		<option value="top-right" <?php echo ($option5['sfsi_icons_Alignment']=='top-right') ?  'selected="selected"' : '' ;?> >Top - Right</option>
		<option value="center-left" <?php echo ($option5['sfsi_icons_Alignment']=='center-left') ?  'selected="selected"' : '' ;?> >Center - Left</option>
		<option value="center-right" <?php echo ($option5['sfsi_icons_Alignment']=='center-right') ?  'selected="selected"' : '' ;?> >Center - Right</option>
		<option value="bottom-left" <?php echo ($option5['sfsi_icons_Alignment']=='bottom-left') ?  'selected="selected"' : '' ;?> >Bottom - Left</option>
		<option value="bottom-right" <?php echo ($option5['sfsi_icons_Alignment']=='bottom-right') ?  'selected="selected"' : '' ;?> >Bottom - Right</option>
	    </select>
	</div>
  </div> 
