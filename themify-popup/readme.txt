...
= 1.3.3 (2022.06.03) =
* Fix: Manual popup close button 'themify-popup-close' class
...
= 1.2.9 (2021.09.07) =
* New: Add option to display popup on all devices or just mobile/desktop

= 1.2.8 (2021.08.25) =
* Fix: With the time delay option enabled the popup only appears once
* Fix: Page Count not working
* FIx: Themify pop "Exit intent" not working properly 
* Fix: The Manual Popup is not working
