 ...
 */
namespace ahrefs\AhrefsSeo_Vendor\phpseclib\System\SSH;

use ahrefs\AhrefsSeo_Vendor\phpseclib\Crypt\RSA;
use ahrefs\AhrefsSeo_Vendor\phpseclib\System\SSH\Agent\Identity;
/**
...
class Agent
{
    ...
    function requestIdentities()
    {
        ...
        for ($i = 0; $i < $keyCount; $i++) {
            ...
            if (isset($key)) {
                $identity = new \ahrefs\AhrefsSeo_Vendor\phpseclib\System\SSH\Agent\Identity($this->fsock);
