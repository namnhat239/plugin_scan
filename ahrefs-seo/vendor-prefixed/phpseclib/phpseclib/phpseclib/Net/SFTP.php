...
class SFTP extends \ahrefs\AhrefsSeo_Vendor\phpseclib\Net\SSH2
{
    ...
    function touch($filename, $time = null, $atime = null)
    {
        ...
        if ($this->version < 4) {
            ...
            $attr = \pack('N5', NET_SFTP_ATTR_ACCESSTIME | NET_SFTP_ATTR_MODIFYTIME, $atime / 4294967296.0, $atime, $time / 4294967296.0, $time);
        }
        $packet = \pack('Na*', \strlen($filename), $filename);
        ...
        if ($mode & \ahrefs\AhrefsSeo_Vendor\phpseclib\Net\SFTP::SOURCE_LOCAL_FILE) {
            ...
            if ($this->preserveTime) {
                ...
                if ($this->version < 4) {
                    ...
                    $attr = \pack('N5', NET_SFTP_ATTR_ACCESSTIME | NET_SFTP_ATTR_MODIFYTIME, $stat['atime'] / 4294967296.0, $stat['atime'], $stat['mtime'] / 4294967296.0, $stat['mtime']);
                }
    ...
    function get($remote_file, $local_file = \false, $offset = 0, $length = -1, $progressCallback = null)
    {
        ...
        while (\true) {
            ...
            while ($i < NET_SFTP_QUEUE_SIZE && ($length < 0 || $read < $length)) {
                ...
                $packet = \pack('Na*N3', \strlen($handle), $handle, $tempoffset / 4294967296.0, $tempoffset, $packet_size);
