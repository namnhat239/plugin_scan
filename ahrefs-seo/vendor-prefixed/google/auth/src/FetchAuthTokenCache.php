 ...
 */
namespace ahrefs\AhrefsSeo_Vendor\Google\Auth;
 ...
 */
class FetchAuthTokenCache implements \ahrefs\AhrefsSeo_Vendor\Google\Auth\FetchAuthTokenInterface, \ahrefs\AhrefsSeo_Vendor\Google\Auth\GetQuotaProjectInterface, \ahrefs\AhrefsSeo_Vendor\Google\Auth\SignBlobInterface, \ahrefs\AhrefsSeo_Vendor\Google\Auth\ProjectIdProviderInterface, \ahrefs\AhrefsSeo_Vendor\Google\Auth\UpdateMetadataInterface
{
    use CacheTrait;
    /**
     ...
     */
    public function __construct(\ahrefs\AhrefsSeo_Vendor\Google\Auth\FetchAuthTokenInterface $fetcher, array $cacheConfig = null, \ahrefs\AhrefsSeo_Vendor\Psr\Cache\CacheItemPoolInterface $cache)
    {
    ...
    {
        if (!$this->fetcher instanceof \ahrefs\AhrefsSeo_Vendor\Google\Auth\SignBlobInterface) {
    ...
    public function signBlob($stringToSign, $forceOpenSsl = \false)
    {
        ...
        if ($this->fetcher instanceof \ahrefs\AhrefsSeo_Vendor\Google\Auth\Credentials\GCECredentials) {
    ...
    {
        if ($this->fetcher instanceof \ahrefs\AhrefsSeo_Vendor\Google\Auth\GetQuotaProjectInterface) {
    ...
    {
        if (!$this->fetcher instanceof \ahrefs\AhrefsSeo_Vendor\Google\Auth\ProjectIdProviderInterface) {
    ...
    {
        if (!$this->fetcher instanceof \ahrefs\AhrefsSeo_Vendor\Google\Auth\UpdateMetadataInterface) {
