 ...
 * the License.
 */
namespace ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\Resource;

use ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\BatchRunPivotReportsRequest;
use ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\BatchRunPivotReportsResponse;
use ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\BatchRunReportsRequest;
use ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\BatchRunReportsResponse;
use ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\CheckCompatibilityRequest;
use ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\CheckCompatibilityResponse;
use ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\Metadata;
use ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\RunPivotReportRequest;
use ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\RunPivotReportResponse;
use ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\RunRealtimeReportRequest;
use ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\RunRealtimeReportResponse;
...
class Properties extends \ahrefs\AhrefsSeo_Vendor\Google\Service\Resource
{
     ...
     */
    public function batchRunPivotReports($property, \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\BatchRunPivotReportsRequest $postBody, $optParams = [])
    {
        $params = ['property' => $property, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('batchRunPivotReports', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\BatchRunPivotReportsResponse::class);
    }
    /**
     ...
     */
    public function batchRunReports($property, \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\BatchRunReportsRequest $postBody, $optParams = [])
    {
        $params = ['property' => $property, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('batchRunReports', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\BatchRunReportsResponse::class);
    }
    /**
     ...
     */
    public function checkCompatibility($property, \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\CheckCompatibilityRequest $postBody, $optParams = [])
    {
        $params = ['property' => $property, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('checkCompatibility', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\CheckCompatibilityResponse::class);
    }
    /**
    ...
    public function getMetadata($name, $optParams = [])
    {
        $params = ['name' => $name];
        $params = \array_merge($params, $optParams);
        return $this->call('getMetadata', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\Metadata::class);
    }
    /**
     ...
     */
    public function runPivotReport($property, \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\RunPivotReportRequest $postBody, $optParams = [])
    {
        $params = ['property' => $property, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('runPivotReport', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\RunPivotReportResponse::class);
    }
    /**
     ...
     */
    public function runRealtimeReport($property, \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\RunRealtimeReportRequest $postBody, $optParams = [])
    {
        $params = ['property' => $property, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('runRealtimeReport', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\RunRealtimeReportResponse::class);
    }
    /**
     ...
     */
    public function runReport($property, \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\RunReportRequest $postBody, $optParams = [])
    {
        $params = ['property' => $property, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('runReport', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\RunReportResponse::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\AnalyticsData\Resource\Properties::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_AnalyticsData_Resource_Properties');
