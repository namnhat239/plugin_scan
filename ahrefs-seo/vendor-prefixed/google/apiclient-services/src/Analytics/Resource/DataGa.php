...
use ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\GaData;
/**
 ...
 *  </code>
 */
class DataGa extends \ahrefs\AhrefsSeo_Vendor\Google\Service\Resource
{
    /**
    ...
    public function get($ids, $startDate, $endDate, $metrics, $optParams = [])
    {
        ...
        return $this->call('get', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\GaData::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\Resource\DataGa::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_Analytics_Resource_DataGa');
