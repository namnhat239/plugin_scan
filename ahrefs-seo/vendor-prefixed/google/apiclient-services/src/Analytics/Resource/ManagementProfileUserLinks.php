...
use ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\EntityUserLink;
use ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\EntityUserLinks;
/**
 ...
 *  </code>
 */
class ManagementProfileUserLinks extends \ahrefs\AhrefsSeo_Vendor\Google\Service\Resource
{
    /**
     ...
     */
    public function insert($accountId, $webPropertyId, $profileId, \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\EntityUserLink $postBody, $optParams = [])
    {
        $params = ['accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('insert', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\EntityUserLink::class);
    }
    /**
    ...
    public function listManagementProfileUserLinks($accountId, $webPropertyId, $profileId, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\EntityUserLinks::class);
    }
    /**
     ...
     * @return EntityUserLink
     */
    public function update($accountId, $webPropertyId, $profileId, $linkId, \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\EntityUserLink $postBody, $optParams = [])
    {
        $params = ['accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'linkId' => $linkId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('update', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\EntityUserLink::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\Resource\ManagementProfileUserLinks::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_Analytics_Resource_ManagementProfileUserLinks');
