...
use ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\AnalyticsDataimportDeleteUploadDataRequest;
use ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\Upload;
use ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\Uploads;
/**
 ...
 *  </code>
 */
class ManagementUploads extends \ahrefs\AhrefsSeo_Vendor\Google\Service\Resource
{
    /**
     ...
     */
    public function deleteUploadData($accountId, $webPropertyId, $customDataSourceId, \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\AnalyticsDataimportDeleteUploadDataRequest $postBody, $optParams = [])
    {
    ...
    public function get($accountId, $webPropertyId, $customDataSourceId, $uploadId, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('get', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\Upload::class);
    }
    /**
    ...
    public function listManagementUploads($accountId, $webPropertyId, $customDataSourceId, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\Uploads::class);
    }
    /**
    ...
    public function uploadData($accountId, $webPropertyId, $customDataSourceId, $optParams = [])
    {
        $params = ['accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'customDataSourceId' => $customDataSourceId];
        $params = \array_merge($params, $optParams);
        return $this->call('uploadData', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\Upload::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\Resource\ManagementUploads::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_Analytics_Resource_ManagementUploads');
