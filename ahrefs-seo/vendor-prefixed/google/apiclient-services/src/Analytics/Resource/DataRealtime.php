...
use ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\RealtimeData;
/**
 ...
 *  </code>
 */
class DataRealtime extends \ahrefs\AhrefsSeo_Vendor\Google\Service\Resource
{
    /**
    ...
    public function get($ids, $metrics, $optParams = [])
    {
        ...
        return $this->call('get', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\RealtimeData::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\Resource\DataRealtime::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_Analytics_Resource_DataRealtime');
