...
use ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\CustomDataSources;
/**
 ...
 *  </code>
 */
class ManagementCustomDataSources extends \ahrefs\AhrefsSeo_Vendor\Google\Service\Resource
{
    /**
    ...
    public function listManagementCustomDataSources($accountId, $webPropertyId, $optParams = [])
    {
        ...
        return $this->call('list', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\CustomDataSources::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\Resource\ManagementCustomDataSources::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_Analytics_Resource_ManagementCustomDataSources');
