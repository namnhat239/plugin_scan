 ...
 *  </code>
 */
class ManagementAccountUserLinks extends \ahrefs\AhrefsSeo_Vendor\Google\Service\Resource
{
    /**
     ...
     */
    public function insert($accountId, \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\EntityUserLink $postBody, $optParams = [])
    {
     ...
     * @return EntityUserLink
     */
    public function update($accountId, $linkId, \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\EntityUserLink $postBody, $optParams = [])
    {
...
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\Resource\ManagementAccountUserLinks::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_Analytics_Resource_ManagementAccountUserLinks');
