...
use ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\CustomDimension;
use ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\CustomDimensions;
/**
 ...
 *  </code>
 */
class ManagementCustomDimensions extends \ahrefs\AhrefsSeo_Vendor\Google\Service\Resource
{
    /**
    ...
    public function get($accountId, $webPropertyId, $customDimensionId, $optParams = [])
    {
        ...
        return $this->call('get', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\CustomDimension::class);
    }
    /**
     ...
     * @return CustomDimension
     */
    public function insert($accountId, $webPropertyId, \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\CustomDimension $postBody, $optParams = [])
    {
        $params = ['accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('insert', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\CustomDimension::class);
    }
    /**
    ...
    public function listManagementCustomDimensions($accountId, $webPropertyId, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\CustomDimensions::class);
    }
    /**
     ...
     * @return CustomDimension
     */
    public function patch($accountId, $webPropertyId, $customDimensionId, \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\CustomDimension $postBody, $optParams = [])
    {
        $params = ['accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'customDimensionId' => $customDimensionId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('patch', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\CustomDimension::class);
    }
    /**
     ...
     * @return CustomDimension
     */
    public function update($accountId, $webPropertyId, $customDimensionId, \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\CustomDimension $postBody, $optParams = [])
    {
        $params = ['accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'customDimensionId' => $customDimensionId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('update', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\CustomDimension::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\Resource\ManagementCustomDimensions::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_Analytics_Resource_ManagementCustomDimensions');
