...
use ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\Goal;
use ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\Goals;
/**
 ...
 *  </code>
 */
class ManagementGoals extends \ahrefs\AhrefsSeo_Vendor\Google\Service\Resource
{
    /**
    ...
    public function get($accountId, $webPropertyId, $profileId, $goalId, $optParams = [])
    {
        ...
        return $this->call('get', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\Goal::class);
    }
    /**
     ...
     * @return Goal
     */
    public function insert($accountId, $webPropertyId, $profileId, \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\Goal $postBody, $optParams = [])
    {
        $params = ['accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('insert', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\Goal::class);
    }
    /**
    ...
    public function listManagementGoals($accountId, $webPropertyId, $profileId, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\Goals::class);
    }
    /**
     ...
     * @return Goal
     */
    public function patch($accountId, $webPropertyId, $profileId, $goalId, \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\Goal $postBody, $optParams = [])
    {
        $params = ['accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'goalId' => $goalId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('patch', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\Goal::class);
    }
    /**
     ...
     * @return Goal
     */
    public function update($accountId, $webPropertyId, $profileId, $goalId, \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\Goal $postBody, $optParams = [])
    {
        $params = ['accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'goalId' => $goalId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('update', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\Goal::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\Resource\ManagementGoals::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_Analytics_Resource_ManagementGoals');
