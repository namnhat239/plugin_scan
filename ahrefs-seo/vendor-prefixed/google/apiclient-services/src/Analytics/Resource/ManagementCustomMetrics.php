...
use ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\CustomMetric;
use ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\CustomMetrics;
/**
 ...
 *  </code>
 */
class ManagementCustomMetrics extends \ahrefs\AhrefsSeo_Vendor\Google\Service\Resource
{
    /**
    ...
    public function get($accountId, $webPropertyId, $customMetricId, $optParams = [])
    {
        ...
        return $this->call('get', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\CustomMetric::class);
    }
    /**
     ...
     * @return CustomMetric
     */
    public function insert($accountId, $webPropertyId, \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\CustomMetric $postBody, $optParams = [])
    {
        $params = ['accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('insert', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\CustomMetric::class);
    }
    /**
    ...
    public function listManagementCustomMetrics($accountId, $webPropertyId, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\CustomMetrics::class);
    }
    /**
     ...
     * @return CustomMetric
     */
    public function patch($accountId, $webPropertyId, $customMetricId, \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\CustomMetric $postBody, $optParams = [])
    {
        $params = ['accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'customMetricId' => $customMetricId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('patch', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\CustomMetric::class);
    }
    /**
     ...
     * @return CustomMetric
     */
    public function update($accountId, $webPropertyId, $customMetricId, \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\CustomMetric $postBody, $optParams = [])
    {
        $params = ['accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'customMetricId' => $customMetricId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('update', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\CustomMetric::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\Resource\ManagementCustomMetrics::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_Analytics_Resource_ManagementCustomMetrics');
