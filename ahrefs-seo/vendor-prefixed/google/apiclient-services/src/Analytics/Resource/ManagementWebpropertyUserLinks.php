 ...
 *  </code>
 */
class ManagementWebpropertyUserLinks extends \ahrefs\AhrefsSeo_Vendor\Google\Service\Resource
{
    /**
     ...
     */
    public function insert($accountId, $webPropertyId, \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\EntityUserLink $postBody, $optParams = [])
    {
     ...
     * @return EntityUserLink
     */
    public function update($accountId, $webPropertyId, $linkId, \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\EntityUserLink $postBody, $optParams = [])
    {
...
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\Resource\ManagementWebpropertyUserLinks::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_Analytics_Resource_ManagementWebpropertyUserLinks');
