...
use ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\UnsampledReport;
use ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\UnsampledReports;
/**
 ...
 *  </code>
 */
class ManagementUnsampledReports extends \ahrefs\AhrefsSeo_Vendor\Google\Service\Resource
{
    /**
    ...
    public function get($accountId, $webPropertyId, $profileId, $unsampledReportId, $optParams = [])
    {
        $params = ['accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'unsampledReportId' => $unsampledReportId];
        $params = \array_merge($params, $optParams);
        return $this->call('get', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\UnsampledReport::class);
    }
    /**
     ...
     * @return UnsampledReport
     */
    public function insert($accountId, $webPropertyId, $profileId, \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\UnsampledReport $postBody, $optParams = [])
    {
        $params = ['accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'postBody' => $postBody];
        $params = \array_merge($params, $optParams);
        return $this->call('insert', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\UnsampledReport::class);
    }
    /**
    ...
    public function listManagementUnsampledReports($accountId, $webPropertyId, $profileId, $optParams = [])
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', [$params], \ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\UnsampledReports::class);
    }
}
// Adding a class alias for backwards compatibility with the previous class name.
\class_alias(\ahrefs\AhrefsSeo_Vendor\Google\Service\Analytics\Resource\ManagementUnsampledReports::class, 'ahrefs\\AhrefsSeo_Vendor\\Google_Service_Analytics_Resource_ManagementUnsampledReports');
