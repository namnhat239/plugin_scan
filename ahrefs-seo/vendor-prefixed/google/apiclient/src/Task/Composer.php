...
use ahrefs\AhrefsSeo_Vendor\Composer\Script\Event;
use ahrefs\AhrefsSeo_Vendor\Symfony\Component\Filesystem\Filesystem;
use ahrefs\AhrefsSeo_Vendor\Symfony\Component\Finder\Finder;
...
class Composer
{
     ...
     */
    public static function cleanup(\ahrefs\AhrefsSeo_Vendor\Composer\Script\Event $event, \ahrefs\AhrefsSeo_Vendor\Symfony\Component\Filesystem\Filesystem $filesystem = null)
    {
        ...
        if ($servicesToKeep) {
            ...
            $filesystem = $filesystem ?: new \ahrefs\AhrefsSeo_Vendor\Symfony\Component\Filesystem\Filesystem();
    ...
    {
        $finder = (new \ahrefs\AhrefsSeo_Vendor\Symfony\Component\Finder\Finder())->directories()->depth('== 0');
    ...
    private static function getServicesToRemove($serviceDir, array $servicesToKeep)
    {
        ...
        return (new \ahrefs\AhrefsSeo_Vendor\Symfony\Component\Finder\Finder())->directories()->depth('== 0')->in($serviceDir)->exclude($servicesToKeep);
    }
}
