...
class Model implements \ArrayAccess
{
    ...
    {
        if ($value instanceof \ahrefs\AhrefsSeo_Vendor\Google\Model) {
    ...
    {
        if ($obj && !\is_array($obj)) {
            throw new \ahrefs\AhrefsSeo_Vendor\Google\Exception("Incorrect parameter type passed to {$method}(). Expected an array.");
        }
    }
    /** @return bool */
