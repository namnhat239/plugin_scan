...
<div class="ahrefs-header-wrap">
	<div class="ahrefs-header">
		...
		<div>
			<img src="<?php echo esc_attr( AHREFS_SEO_IMAGES_URL . 'logo.svg' ); ?>" class="logo">
		...
		<div class="content-right">
			...
			--><div>
				<a class="content-hint-how" href="https://help.ahrefs.com/en/collections/2253902-wordpress-plugin" target="_blank"> 
				<?php
				esc_html_e( 'Help', 'ahrefs-seo' );
				?>
				</a>
			</div><!--
	 ...
	 disallowed
					...
					if ( ! $allow_run_audit ) {
						?>
	 title="<?php esc_attr_e( 'Sorry, you are not allowed to run content audits.', 'ahrefs-seo' ); ?>"
						<?php
	 ...
	 title="<?php esc_attr_e( 'Sorry, you are not allowed to run content audits.', 'ahrefs-seo' ); ?>"
				...
				<div class="audit-progressbar" title="
				<?php
				esc_attr_e( 'To make the audit go faster, we recommend leaving the browser tab open.', 'ahrefs-seo' );
				?>
				&nbsp;<a target='_blank' href='https://help.ahrefs.com/en/articles/5879793-what-does-the-speed-of-the-audit-depend-on' class='internal-hint-a'>
<?php
esc_attr_e( 'Learn more', 'ahrefs-seo' );
?>
</a>">
					<div class="position"
						<?php
