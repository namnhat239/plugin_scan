...
<div class="more-wrap">
	...
	<div class="more-column-action">
		...
		<p>
		<?php
		esc_html_e( 'This page is not ranking in the top positions for any keyword, but it is in the top 50th percentile of all pages on your website when it comes to traffic.', 'ahrefs-seo' );
		?>
		</p>
		<p>
		<?php
		esc_html_e( 'We suggest excluding this article from your content audit so that it doesn’t affect your score.', 'ahrefs-seo' );
		?>
		</p>
		<div class="with-button"><a href="#" class="button action-stop"><span></span>
		<?php
