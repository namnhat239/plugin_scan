...
<li>
	<p>
	<?php
	esc_html_e( 'Consolidate', 'ahrefs-seo' );
	?>
	</p>
	<p>
	<?php
	esc_html_e( 'There are multiple articles on your blog targeting the same topic. We suggest consolidating content from all the similar articles into just one well-performing article.', 'ahrefs-seo' );
	?>
	</p>
	<?php
	...
	?>
	<p class="with-button">
		<a class="link-question" href="https://ahrefs.com/blog/keyword-cannibalization/" target="_blank">
		<?php
		esc_html_e( 'How to consolidate pages', 'ahrefs-seo' );
		?>
		</a>
	</p>
</li>
