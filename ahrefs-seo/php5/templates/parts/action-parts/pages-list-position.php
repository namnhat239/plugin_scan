...
if ( count( $locals['items'] ) ) {
	...
	$subtitle = sprintf( _n( '%d underperforming page that can be merged with the top-performing one', '%d underperforming pages that can be merged with the top-performing one', count( $locals['items'] ), 'ahrefs-seo' ), count( $locals['items'] ) );
	?>
	<div class="more-page-content">
		<div class="details-related-item details-related-header">
			...
			<div class="details-position">
				<span class="details-position-value">
				<?php
				echo esc_html_e( 'Position', 'ahrefs-seo' );
				?>
	</span>
		...
		foreach ( $locals['items'] as $post_tax ) {
			...
			<div class="details-related-item">
				...
				<div class="details-position">
					<span class="details-position-value">
					<?php
					Ahrefs_Seo_Table_Content::print_position( $position );
					?>
		</span>
