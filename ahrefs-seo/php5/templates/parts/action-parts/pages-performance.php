...
if ( isset( $locals['no-keyword'] ) && $locals['no-keyword'] ) {
	?><div class="position-info"><span class="icon-red"></span>
	<?php
	esc_html_e( 'No target keyword found', 'ahrefs-seo' );
	?>
	</div>
	<?php
	...
	if ( $pos <= 3 ) {
		?>
		<div class="position-info"><span class="icon-green"></span>
		<?php
		esc_html_e( 'Position in top 3', 'ahrefs-seo' );
		?>
		</div>
		<?php
	} elseif ( $pos <= 20 ) {
		?>
		<div class="position-info"><span class="icon-yellow"></span>
		<?php
		esc_html_e( 'Position below top 3', 'ahrefs-seo' );
		?>
		</div>
		<?php
	} else {
		...
		<div class="position-info"><span class="icon-red"></span>
		<?php
		esc_html_e( 'Position below top 20', 'ahrefs-seo' );
		?>
		</div>
		<?php
	}
...
if ( isset( $locals['unique-keyword'] ) ) {
	if ( $locals['unique-keyword'] ) {
		...
		<div class="position-info"><span class="icon-green"></span>
		<?php
		esc_html_e( 'Topic is unique', 'ahrefs-seo' );
		?>
		</div>
		<?php
	} else {
		...
		<div class="position-info"><span class="icon-yellow"></span>
		<?php
		esc_html_e( 'Topic is not unique', 'ahrefs-seo' );
		?>
		</div>
		<?php
	}
...
if ( isset( $locals['low-traffic'] ) ) {
	...
	<div class="position-info"><span class="icon-red"></span>
	<?php
	esc_html_e( 'Low traffic', 'ahrefs-seo' );
	?>
	</div>
	<?php
}
if ( isset( $locals['backlinks'] ) ) {
	if ( (int) $locals['backlinks'] > 0 ) {
		...
		<div class="position-info"><span class="icon-yellow"></span>
		<?php
		esc_html_e( 'No backlinks', 'ahrefs-seo' );
		?>
		</div>
		<?php
	}
...
if ( isset( $locals['decent-traffic'] ) ) {
	...
	<div class="position-info"><span class="icon-green"></span>
	<?php
	esc_html_e( 'Decent non-organic traffic', 'ahrefs-seo' );
	?>
	</div>
	<?php
}
...
if ( $additional['is_noncanonical'] ) {
	?>
		<div class="position-info"><span class="icon-yellow"></span>
		<?php
		esc_html_e( 'Non-canonical', 'ahrefs-seo' );
		?>
	</div>
		<?php
}
if ( $additional['is_redirected'] ) {
	?>
		<div class="position-info"><span class="icon-yellow"></span>
		<?php
		esc_html_e( 'Redirect', 'ahrefs-seo' );
		?>
	</div>
		<?php
}
