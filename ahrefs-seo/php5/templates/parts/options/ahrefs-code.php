...
<?php echo esc_attr( AHREFS_SEO_IMAGES_URL ); ?>ahrefs-wp-plugin-2-o@3x.jpg 3x"
		...
		<div class="two-rows-wrap">
			<div class="single-row-wrap">
				...
				<p class="help">
				<?php
				esc_html_e( 'Automate content audits and grow organic traffic to your website with Ahrefs SEO WordPress plugin. Just click the link below and connect your Ahrefs account with this plugin.', 'ahrefs-seo' );
				?>
				</p>
				...
				<a href="<?php echo esc_attr( $link_user ); ?>" target="_blank" class="get-code-button" id="ahrefs_get">
					<span class="text">
					<?php
					esc_html_e( 'Get my authorization code', 'ahrefs-seo' );
					?>
					</span>
			...
			<div class="single-row-wrap">
				<p class="help-title">
				<?php
				esc_html_e( 'I’m new to Ahrefs | I’m a Webmaster Tools User', 'ahrefs-seo' );
				?>
				</p>
				<p class="help">
				<?php
		...
		<div class="new-token-button">
			<label class="label">
			<?php
			esc_attr_e( 'Authorization code', 'ahrefs-seo' );
			?>
			</label>
