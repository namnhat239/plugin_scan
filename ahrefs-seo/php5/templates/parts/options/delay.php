...
if ( ! defined( 'DISABLE_WP_CRON' ) || ! DISABLE_WP_CRON ) {
	...
	<div class="notice notice-warning">
		<p class="block-title">
			<?php
			esc_html_e( 'Warning', 'ahrefs-seo' );
			?>
		</p>
		<p class="block-text">
			<?php
			esc_html_e( 'We noticed that you have WP-Cron enabled on your website. The Ahrefs SEO plugin uses cron jobs to run audits in background, and with WP-Cron the speed you selected is not guaranteed. We recommend switching from WP-Cron to a system cron instead. ', 'ahrefs-seo' );
			?>
			<a href="https://help.ahrefs.com/en/articles/5879793-what-does-the-speed-of-the-audit-depend-on" class="no-underline">
			<?php
			esc_html_e( 'Learn how to do this', 'ahrefs-seo' );
			?>
	</a>
		</p>
	</div>
...
<div class="block-delay-time">
	<div>
		<select name="audit_cron_delay" id="audit_cron_delay">
			...
			?>
		</select><a id="audit_cron_delay_reset" style="display: none;" href="#">
		<?php
		esc_html_e( 'Reset to default', 'ahrefs-seo' );
		?>
		</a>
