...
class Post_Tax_With_Keywords extends Post_Tax {
	...
	*/
	 ...
	 */
	public static function create_from( Post_Tax $post_tax ) {
	 ...
	 * @return Post_Tax_With_Keywords
	 */
	public function set_keyword_current( $current_keyword ) {
	 ...
	 * @return Post_Tax_With_Keywords
	 */
	public function set_keywords( array $keywords = null ) {
	 ...
	 * @return Post_Tax_With_Keywords
	 */
	public function set_keywords2( Data_Content_Storage $keywords2 = null ) {
	 ...
	 * @return Post_Tax_With_Keywords
	 */
	public function set_keywords_imported( Data_Keywords $data_keywords = null ) {
	 ...
	 * @return Post_Tax_With_Keywords
	 */
	public function set_keywords_pos( array $keywords_pos ) {
		$this->keywords_pos = [];
		foreach ( $keywords_pos as $row ) {
			if ( is_object( $row ) && $row instanceof Data_Keyword ) {
				/** @var Data_Keyword $row  */
	 ...
	 * @return Post_Tax_With_Keywords
	 */
	public function set_keyword_source( $source_id = null ) {
	 ...
	 * @return string|null
	 */
	public function get_keyword_curent() {
	 ...
	 * @return string|null
	 */
	public function get_keyword_manual() {
		return $this->manual_keyword;
	}
	/**
	 * Get position of curernt keyword
	 *
	 * @return float|null
	 */
	 ...
	 */
	public function get_keywords_imported() {
		return isset( $this->keywords_imported ) ? $this->keywords_imported : new Data_Keywords();
	}
	/**
	 ...
	 * @return bool|null
	 */
	public function get_keywords2_low_len() {
	 ...
	 */
	public function get_keywords_pos() {
	 ...
	 * @return string|null
	 */
	public function get_keyword_source() {
	 ...
	 * @return bool|null
	 */
	public function get_is_keyword_approved() {
	...
	public function load_from_db() {
		...
		if ( is_array( $fields ) ) {
			...
			$this->keywords          = is_string( $fields['kw_gsc'] ) ? (array) json_decode( $fields['kw_gsc'], true ) : null;
			$this->keywords2         = [];
			...
			if ( ! is_null( $this->keywords2_low_len ) && $this->keywords2_low_len ) {
				$this->keywords2 = [];
			}
