...
abstract class Source {
	 ...
	 * @return void
	 */
	abstract protected function fill_vars();
	/**
	 ...
	 */
	abstract public function is_noindex( Post_Tax $post_tax);
	/**
	 * Get source ID.
	 *
	 * @return string
	 ...
	 *
	 * @param Post_Tax $post_tax Post or term.
	 * @return array<string, string|int|array>|null Arguments for wp_query.
	 */
	protected function get_post_tax_args( Post_Tax $post_tax ) {
		if ( $post_tax->is_post() ) {
			return [
