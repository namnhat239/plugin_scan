...
class Data_Keyword implements \JsonSerializable {
	 ...
	 */
	public function __construct( $keyword = null, $source_id = null, Data_Clicks_Info $clicks_info = null, $url = null, $country_code = '' ) {
	 ...
	 * }
	 */
	public function as_gsc_array() {
		$clicks = isset( $this->clicks_info ) ? $this->clicks_info : new Data_Clicks_Info( null, null, null );
		return [
			'query'  => isset( $this->keyword ) ? $this->keyword : '',
			'clicks' => ! empty( $clicks->get_clicks() ) ? $clicks->get_clicks() : 0,
			'pos'    => ! empty( $clicks->get_position() ) ? $clicks->get_position() : Ahrefs_Seo_Data_Content::POSITION_MAX,
			'impr'   => ! empty( $clicks->get_impressions() ) ? $clicks->get_impressions() : 0,
		];
	}
	/**
	 * Get keyword
	 ...
	 */
	public function get_clicks_info() {
	 ...
	 * @return Data_Keyword
	 */
	public function set_clicks_info( Data_Clicks_Info $clicks_info = null ) {
		$this->clicks_info = $clicks_info;
		return $this;
	}
	/**
	 ...
	 * @return bool
	 */
	public function is_same_keyword( $keyword ) {
