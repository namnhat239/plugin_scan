...
class Countries {
	...
	const OPTION_COUNTRY      = 'ahrefs-seo-content-country';
	const DEFAULT_COUNTRY     = ''; // empty value = All countries.
	const DEFAULT_CODE_AHREFS = 'us';
	/**
	 ...
	 * @return void
	 */
	public function set_country( $country_code3 = null ) {
		if ( is_null( self::get_country_fields( isset( $country_code3 ) ? $country_code3 : '' ) ) ) {
	 ...
	 */
	public static function get_country_code_ahrefs( $country_code3 ) {
	 ...
	 */
	public function get_country_name( $country_code3 = null ) {
		$result = self::get_country_fields( isset( $country_code3 ) ? $country_code3 : '' );
	 ...
	 */
	public function get_google_list() {
	 ...
	 */
	protected static function get_country_fields( $country_code3 ) {
		if ( '' !== $country_code3 ) {
			$data = self::get_full_list();
			foreach ( $data as $country_fields ) {
	 ...
	 */
	protected static function get_full_list() {
		return [
			[
				'ahrefs' => 'us',
				'google' => '',
