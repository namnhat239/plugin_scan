...
class Content_Audit {
	 ...
	 */
	public function get_unprocessed_item_from_new( string $what_to_return ) : array {
		global $wpdb;
	...
	public function update_backlinks_values( Post_Tax $post_tax, Data_Metrics_Extended $data, ?string $error = null ) : void {
		global $wpdb;
		$backlinks   = $data->get_backlinks() ?? -1;
		$ref_domains = $data->get_ref_domains() ?? -1;
	 ...
	 */
	public function get_time_period_for( Post_Tax $post_tax ) : int {
