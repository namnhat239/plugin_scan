...
class Sources {
	...
	public const SOURCE_NO_KEYWORD = 'no-keyword';
	public const SOURCE_TOO_SHORT  = 'too-short';
	public const SOURCE_GSC        = 'gsc';
	public const SOURCE_TF_IDF     = 'tf-idf';
	public const SOURCE_MANUAL     = 'manual';
	public const SOURCE_YOASTSEO   = 'yoast';
	public const SOURCE_AIOSEO     = 'aioseo';
	public const SOURCE_RANKMATH   = 'rankmath';
	// additional sources.
	public const SOURCE_EXT_WORDPRESS   = 'wp';
	public const SOURCE_EXT_SAVED       = 'saved';
	public const SOURCE_EXT_REDIRECTION = 'red';
	 ...
	 * @return void
	 */
	public function set( Sources $instance ) : void {
	 ...
	 */
	private function get_all_sources() : array {
		return [
			new Source_Yoast(),
			new Source_Aioseo(),
			new Source_Rankmath(),
			new Source_Redirection(),
			new Source_WordPress(),
		];
	}
	 ...
	 * @return Source[] List of sources.
	 */
	public function get_noindex_sources() : array {
	 ...
	 */
	public function get_keywords_sources() : array {
	 ...
	 */
	public function get_canonical_url_sources() : array {
	 ...
	 */
	public function get_redirected_url_sources() : array {
	 ...
	 */
	public static function validate_db_source( ?string $source_id ) : ?string {
		...
		return in_array(
			$source_id,
			[
				self::SOURCE_NO_KEYWORD,
				self::SOURCE_TOO_SHORT,
				self::SOURCE_GSC,
				self::SOURCE_TF_IDF,
				self::SOURCE_MANUAL,
				self::SOURCE_YOASTSEO,
				self::SOURCE_AIOSEO,
				self::SOURCE_RANKMATH,
			],
			true
		) ? $source_id : null;
	}
	 ...
	 * @return bool
	 */
	public static function is_source_imported( ?string $source_id ) : bool {
	 ...
	 */
	public function has_active_source( string $source_id ) : bool {
		static $result = [];
	 ...
	 * @return void
	 */
	public static function register_post_hooks() : void {
	 ...
	 * @return void
	 */
	public static function unregister_post_hooks() : void {
		if ( self::$hooks_initialized ) {
	 ...
	 * @return string Title.
	 */
	public static function get_title( string $source_id ) : string {
		switch ( $source_id ) {
			case self::SOURCE_EXT_WORDPRESS:
