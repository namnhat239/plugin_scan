...
class Ahrefs_Seo_Content_Settings extends Ahrefs_Seo_Content {
	...
	private const OPTION_SCOPE_UPDATED             = 'ahrefs-seo-content-scope-updated';
	private const OPTION_SCOPE_LAST_HASH           = 'ahrefs-seo-content-scope-last-hash';
	private const OPTION_SCOPE_EXISTING_POST_TYPES = 'ahrefs-seo-content-scope-existing-post-types';
	 ...
	 */
	public function set_options_from_request() : bool {
		$result = [];
	 ...
	 */
	public function get_custom_post_types( bool $skip_product = true ) : array {
	 ...
	 * @return void
	 */
	public function maybe_turn_on_products() : void {
	 ...
	 * @return bool
	 */
	public function is_scope_updated() : bool {
	 ...
	 * @return void
	 */
	public function reset_scope_updated() : void {
	 ...
	 */
	public function has_new_cpt_for_tip() : array {
		return array_diff(
			array_keys( $this->get_custom_post_types( false ) ),
			(array) get_option( self::OPTION_SCOPE_EXISTING_POST_TYPES, [] ),
			$this->get_custom_post_types_enabled( true )
		);
	}
	 ...
	 * @return void
	 */
	public function approve_existing_cpt() : void {
