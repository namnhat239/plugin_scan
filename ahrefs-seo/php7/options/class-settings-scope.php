...
class Settings_Scope {
	...
	public static function is_enabled_for_post_type( string $post_type ) : bool {
		return Option_Post::exists( $post_type ) ? ( new Option_Post( $post_type ) )->is_enabled() : false;
	}

	/**
	 * Is "Other" section enabled?
	 *
	 * @return bool
	 */
	public static function is_enabled_for_others() : bool {
		return ( new Option_Section() )->is_enabled();
	}
	...
	public static function is_enabled_for_taxonomy( string $taxonomy ) : bool {
		return Option_Taxonomy::exists( $taxonomy ) ? ( new Option_Taxonomy( $taxonomy, '' ) )->is_enabled() : false;
	}
