...
if ( $is_suggested ) { // item has non-empty suggested keyword.
	...
	<div class="ahrefs-content-tip tip-notice tip-keyword-need-approve">
		...
		if ( $post_tax->user_can_manage() ) {
			?>
			<div class="buttons">
				<a class="button button-primary button-keyword-approve" id="keyword_approve_button" href="#"><?php esc_html_e( 'Approve', 'ahrefs-seo' ); ?></a>
				<a class="button-keyword-change" href="#"><?php esc_html_e( 'Change...', 'ahrefs-seo' ); ?></a>
			</div>
			<?php
		}
		?>
