		...
		<ol class="subitems">
			<li>
				<a href="<?php echo esc_attr( $get_code_link ); ?>" target="_blank" class="get-code-button">
					<span class="text"><?php esc_html_e( 'Get authorization code from Google', 'ahrefs-seo' ); ?></span>
					<img src="<?php echo esc_attr( AHREFS_SEO_IMAGES_URL . 'link-open.svg' ); ?>" class="icon">
				</a>
			</li>
			<li>
				<div class="new-token-button">
					<label class="label"><?php esc_html_e( 'Enter the received code', 'ahrefs-seo' ); ?></label>
					<div class="input_button">
						...
						<a href="#" class="button button-primary" id="step2_1_submit"><?php esc_html_e( 'Connect GA & GSC accounts', 'ahrefs-seo' ); ?></a>
					</div>
