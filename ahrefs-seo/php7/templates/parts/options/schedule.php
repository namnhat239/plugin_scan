...
<div class="block-text">
	<?php esc_html_e( 'Regularly check your website’s content to have all pages’ metrics, rankings and content suggestions updated.', 'ahrefs-seo' ); ?><br>
</div>
<div class="block-schedule-checkbox">
	<label><input type="checkbox" name="schedule_enabled" value="1"<?php checked( $enabled ); ?>><?php esc_html_e( 'Run scheduled content audits', 'ahrefs-seo' ); ?></label>
...
<div class="block-schedule-time">
	...
	<div id="schedule_day_wrap" style="display: none;">
		<span id="schedule_each" style="display: none;"><?php echo esc_html_x( 'each', 'Start of "each Sunday" sentence', 'ahrefs-seo' ); ?></span>
		...
		<span class="schedule_every"><?php echo esc_html_x( 'every', 'Start of "every 31st of the month" sentence', 'ahrefs-seo' ); ?></span>
		...
		<span class="schedule_every"><?php echo esc_html_x( 'of the month', 'End of "every 31st of the month" sentence', 'ahrefs-seo' ); ?></span>
	</div>
	<div>
		<span><?php echo esc_html_x( 'at', 'Start of "at 08:00 AM" sentence', 'ahrefs-seo' ); ?></span>
...
<div>
	...
	if ( $enabled ) {
		...
		<p>
			...
			echo sprintf( esc_html__( 'The next content audit run is scheduled in: %s.', 'ahrefs-seo' ), esc_html( human_time_diff( $time_now, $next['time'] ) ) );
			?>
		</p>
		<?php
	}
