...
<div class="new-token-button">
	<label class="label" for="gsc_account"><?php esc_html_e( 'Google Search Console site:', 'ahrefs-seo' ); ?></label>
	<select class="account<?php echo esc_attr( $incorrect ? ' incorrect-value' : '' ); ?>" name="gsc_site" id="gsc_account">
		<option value="" <?php selected( $gsc_site, '', true ); ?>><?php esc_html_e( 'Please select', 'ahrefs-seo' ); ?></option>
		<?php
		$last_account = '';
