...
<div class="ahrefs-content-tip" data-time="subsequent" data-id="<?php echo esc_attr( $locals['tip_id'] ); ?>">
	...
	<div class="text"><?php esc_html_e( 'In the previous audit, we’ve found some articles with unapproved keywords. We recommend going through each suggested keyword to make sure it’s the same keyword you’ve optimized an article for.', 'ahrefs-seo' ); ?></div>
