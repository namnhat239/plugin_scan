...
<div class="more-wrap">
	<div class="more-column-performance">
		...
		$view->show_part(
			...
			[
				...
				'low-traffic'    => true,
				'backlinks'      => $backlinks,
				'unique-keyword' => $has_keyword ? null : ( $is_keyword_unique ? null : false ), // do not show unique keyword here.
			]
		);
		?>
	</div>
	<div class="more-column-action wider">
		...
		<div class="column-title with-list"><?php esc_html_e( 'Recommended actions', 'ahrefs-seo' ); ?></div>
		<ol>
			<?php
