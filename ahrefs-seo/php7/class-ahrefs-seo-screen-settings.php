...
class Ahrefs_Seo_Screen_Settings extends Ahrefs_Seo_Screen {
	...
	public const TAB_ANALYTICS = 'analytics';
	public const TAB_ACCOUNT   = 'account';
	public const TAB_DATA      = 'my-audit-data';

	public const CSV_DATA_EXPORT = 'export-data';
	 ...
	 * @since 0.8.0
	 */
	public function ajax_options_new_cpt_tip_close() : void {
