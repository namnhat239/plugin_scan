...
= 1.5.6 = 
* [Task] : Tested compatibility with WordPress 5.8

= 1.5.5 = 
* [Task] : Shifted the IP address of the panel to another server due to old Datacenter issues
* [Task] : Tested compatibility with WordPress 5.7

= 1.5.4 = 
* [Task] : Tested compatibility with WordPress 5.6
