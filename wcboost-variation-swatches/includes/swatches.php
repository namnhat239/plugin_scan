...
class Swatches {
	...
	public function enqueue_scripts() {
		wp_enqueue_style( 'wcboost-variation-swatches', plugins_url( 'assets/css/frontend.css', WCBOOST_VARIATION_SWATCHES_FILE ), [], Plugin::instance()->version );
		wp_add_inline_style( 'wcboost-variation-swatches', $this->inline_style() );

		wp_enqueue_script( 'wcboost-variation-swatches', plugins_url( 'assets/js/frontend.js', WCBOOST_VARIATION_SWATCHES_FILE ), [ 'jquery' ], Plugin::instance()->version, true );
