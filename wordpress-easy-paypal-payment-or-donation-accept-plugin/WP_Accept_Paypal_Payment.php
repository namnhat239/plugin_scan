...
define('WP_PAYPAL_PAYMENT_ACCEPT_PLUGIN_VERSION', '4.9.9');
...
function wpapp_add_settings_link( $links, $file ) {
	...
	$settings_link = '<a href="options-general.php?page=wordpress-easy-paypal-payment-or-donation-accept-plugin%2Fwpapp_admin_menu.php">' . (__( "Settings", "wp-accept-payments-for-paypal" )) . '</a>';
