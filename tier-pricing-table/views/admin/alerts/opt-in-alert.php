...
<div class="tpt-alert">
    ...
    <div class="tpt-alert__text">
        <div class="tpt-alert__inner">
			<?php
			_e( 'Opt in for upgrading and using more features!',
				'tier-pricing-table' );
			?>
        </div>
    </div>
    ...
    <div class="tpt-alert__buttons">
        <div class="tpt-alert__inner">
            <a class="tpt-button--accent tpt-button tpt-button--bounce"
               href="<?php echo tpt_fs()->get_reconnect_url(); ?>"><?php _e( 'Activate Plugin!',
					'tier-pricing-table' ); ?></a>

            <a class="tpt-button tpt-button--default" href="<?php echo $contactUsUrl; ?>"><?php _e( 'Contact us',
					'tier-pricing-table' ); ?></a>
        </div>
    </div>
</div>