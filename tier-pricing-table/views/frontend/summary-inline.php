...
do_action( 'tier_pricing_table/product_page/before_inline_summary', $totalLabel, $eachLabel );
...
<?php do_action( 'tier_pricing_table/product_page/after_inline_summary', $totalLabel, $eachLabel ); ?>
