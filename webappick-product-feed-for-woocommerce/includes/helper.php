...
if ( ! function_exists('woo_feed_import_config') ) {
    ...
    function woo_feed_import_config() {
	    ...
	    $wpf_import_feed_name = CTXFEED_filter_securing_input_cb("POST", @$_FILES['wpf_import_feed_name'], "file_name" );
	    $wpf_import_file_name = CTXFEED_filter_securing_input_cb("POST", @$_FILES['wpf_import_file']['name'], "file_name" );
	    $wpf_import_file_tmp_name = CTXFEED_filter_securing_input_cb("POST", @$_FILES['wpf_import_file']['tmp_name'], "file_name" );
