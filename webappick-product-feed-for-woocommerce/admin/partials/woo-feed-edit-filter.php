			...
			<table class="table widefat fixed" id="wf_campaign_url_builder">
				...
				<tr>
					...
					<td>
						...
						<input type="text" name="campaign_parameters[utm_medium]" id="utm_medium" class="regular-text" placeholder="*<?php esc_attr_e( 'Campaign Medium', 'woo-feed' ); ?>" value="<?php echo ! empty( $feedRules['campaign_parameters']['utm_medium'] ) ? esc_attr( $feedRules['campaign_parameters']['utm_medium'] ) : 'cpc'; ?>">
